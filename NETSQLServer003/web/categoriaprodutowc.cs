...
namespace GeneXus.Programs {
   public class categoriaprodutowc : GXWebComponent
   {
      public categoriaprodutowc( )
      {
      ...
      public categoriaprodutowc( IGxContext context )
      {
      ...
      public void execute( short aP0_CategoriaProdutoId )
      {
         this.AV6CategoriaProdutoId = aP0_CategoriaProdutoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "CategoriaProdutoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6CategoriaProdutoId = (short)(NumberUtil.Val( GetPar( "CategoriaProdutoId"), "."));
                  AssignAttri(sPrefix, false, "AV6CategoriaProdutoId", StringUtil.LTrimStr( (decimal)(AV6CategoriaProdutoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6CategoriaProdutoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6CategoriaProdutoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "CategoriaProdutoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Categoria Produto WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("categoriaprodutowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6CategoriaProdutoId,4,0))}, new string[] {"CategoriaProdutoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6CategoriaProdutoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6CategoriaProdutoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCATEGORIAPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6CategoriaProdutoId), 4, 0, ".", "")));
      ...
      {
         return "CategoriaProdutoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Categoria Produto WC" ;
      }
      ...
      protected void WB1F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "categoriaprodutowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CategoriaProdutoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_label_element( context, edtCategoriaProdutoId_Internalname, "Categoria ", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCategoriaProdutoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A30CategoriaProdutoId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCategoriaProdutoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A30CategoriaProdutoId), "ZZZ9") : context.localUtil.Format( (decimal)(A30CategoriaProdutoId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoriaProdutoId_Jsonclick, 0, "Attribute", "", "", "", "", edtCategoriaProdutoId_Visible, edtCategoriaProdutoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_CategoriaProdutoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Categoria Produto WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001F2 */
            pr_default.execute(0, new Object[] {AV6CategoriaProdutoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A30CategoriaProdutoId = H001F2_A30CategoriaProdutoId[0];
               AssignAttri(sPrefix, false, "A30CategoriaProdutoId", StringUtil.LTrimStr( (decimal)(A30CategoriaProdutoId), 4, 0));
               A29FornecedorProdutoNome = H001F2_A29FornecedorProdutoNome[0];
               A28FornecedorProdutoId = H001F2_A28FornecedorProdutoId[0];
               A27PaisProdutoNome = H001F2_A27PaisProdutoNome[0];
               A26PaisProdutoId = H001F2_A26PaisProdutoId[0];
               A40001VendedorProdutoImagem_GXI = H001F2_A40001VendedorProdutoImagem_GXI[0];
               n40001VendedorProdutoImagem_GXI = H001F2_n40001VendedorProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A25VendedorProdutoNome = H001F2_A25VendedorProdutoNome[0];
               A24VendedorProdutoId = H001F2_A24VendedorProdutoId[0];
               A40000ProdutoImagem_GXI = H001F2_A40000ProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A22ProdutoPreco = H001F2_A22ProdutoPreco[0];
               A21ProdutoDescricao = H001F2_A21ProdutoDescricao[0];
               A20ProdutoNome = H001F2_A20ProdutoNome[0];
               A19ProdutoId = H001F2_A19ProdutoId[0];
               A68VendedorProdutoImagem = H001F2_A68VendedorProdutoImagem[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A23ProdutoImagem = H001F2_A23ProdutoImagem[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A29FornecedorProdutoNome = H001F2_A29FornecedorProdutoNome[0];
               A27PaisProdutoNome = H001F2_A27PaisProdutoNome[0];
      ...
      {
         /* Using cursor H001F3 */
         pr_default.execute(1, new Object[] {AV6CategoriaProdutoId});
      ...
      protected void STRUP1F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6CategoriaProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6CategoriaProdutoId"), ".", ","));
      ...
      protected void E121F2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtCategoriaProdutoId_Visible = 0;
         AssignProp(sPrefix, false, edtCategoriaProdutoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCategoriaProdutoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "CategoriaProdutoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6CategoriaProdutoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6CategoriaProdutoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6CategoriaProdutoId", StringUtil.LTrimStr( (decimal)(AV6CategoriaProdutoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6CategoriaProdutoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "categoriaprodutowc", GetJustCreated( ));
         ...
         {
            AV6CategoriaProdutoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6CategoriaProdutoId", StringUtil.LTrimStr( (decimal)(AV6CategoriaProdutoId), 4, 0));
         }
         wcpOAV6CategoriaProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6CategoriaProdutoId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6CategoriaProdutoId != wcpOAV6CategoriaProdutoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6CategoriaProdutoId = AV6CategoriaProdutoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6CategoriaProdutoId = cgiGet( sPrefix+"AV6CategoriaProdutoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6CategoriaProdutoId) > 0 )
         {
            AV6CategoriaProdutoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6CategoriaProdutoId), ".", ","));
            AssignAttri(sPrefix, false, "AV6CategoriaProdutoId", StringUtil.LTrimStr( (decimal)(AV6CategoriaProdutoId), 4, 0));
         }
         else
         {
            AV6CategoriaProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6CategoriaProdutoId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6CategoriaProdutoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6CategoriaProdutoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6CategoriaProdutoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6CategoriaProdutoId_CTRL", StringUtil.RTrim( sCtrlAV6CategoriaProdutoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513763", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("categoriaprodutowc.js", "?202582916513763", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         edtCategoriaProdutoId_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6CategoriaProdutoId',fld:'vCATEGORIAPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131F2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111F2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6CategoriaProdutoId',fld:'vCATEGORIAPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6CategoriaProdutoId',fld:'vCATEGORIAPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6CategoriaProdutoId',fld:'vCATEGORIAPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6CategoriaProdutoId',fld:'vCATEGORIAPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001F2_A30CategoriaProdutoId = new short[1] ;
         H001F2_A29FornecedorProdutoNome = new string[] {""} ;
         H001F2_A28FornecedorProdutoId = new short[1] ;
         H001F2_A27PaisProdutoNome = new string[] {""} ;
         H001F2_A26PaisProdutoId = new short[1] ;
         H001F2_A40001VendedorProdutoImagem_GXI = new string[] {""} ;
         H001F2_n40001VendedorProdutoImagem_GXI = new bool[] {false} ;
         H001F2_A25VendedorProdutoNome = new string[] {""} ;
         H001F2_A24VendedorProdutoId = new short[1] ;
         H001F2_A40000ProdutoImagem_GXI = new string[] {""} ;
         H001F2_A22ProdutoPreco = new decimal[1] ;
         H001F2_A21ProdutoDescricao = new string[] {""} ;
         H001F2_A20ProdutoNome = new string[] {""} ;
         H001F2_A19ProdutoId = new short[1] ;
         H001F2_A68VendedorProdutoImagem = new string[] {""} ;
         H001F2_A23ProdutoImagem = new string[] {""} ;
         ...
         sCtrlAV6CategoriaProdutoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.categoriaprodutowc__default(),
            new Object[][] {
                new Object[] {
               H001F2_A30CategoriaProdutoId, H001F2_A29FornecedorProdutoNome, H001F2_A28FornecedorProdutoId, H001F2_A27PaisProdutoNome, H001F2_A26PaisProdutoId, H001F2_A40001VendedorProdutoImagem_GXI, H001F2_n40001VendedorProdutoImagem_GXI, H001F2_A25VendedorProdutoNome, H001F2_A24VendedorProdutoId, H001F2_A40000ProdutoImagem_GXI,
               H001F2_A22ProdutoPreco, H001F2_A21ProdutoDescricao, H001F2_A20ProdutoNome, H001F2_A19ProdutoId, H001F2_A68VendedorProdutoImagem, H001F2_A23ProdutoImagem
               }
               , new Object[] {
      ...
      private short AV6CategoriaProdutoId ;
      private short wcpOAV6CategoriaProdutoId ;
      ...
      private int edtCategoriaProdutoId_Visible ;
      ...
      private string sCtrlAV6CategoriaProdutoId ;
      ...
      private short[] H001F2_A30CategoriaProdutoId ;
      private string[] H001F2_A29FornecedorProdutoNome ;
      private short[] H001F2_A28FornecedorProdutoId ;
      private string[] H001F2_A27PaisProdutoNome ;
      private short[] H001F2_A26PaisProdutoId ;
      private string[] H001F2_A40001VendedorProdutoImagem_GXI ;
      private bool[] H001F2_n40001VendedorProdutoImagem_GXI ;
      private string[] H001F2_A25VendedorProdutoNome ;
      private short[] H001F2_A24VendedorProdutoId ;
      private string[] H001F2_A40000ProdutoImagem_GXI ;
      private decimal[] H001F2_A22ProdutoPreco ;
      private string[] H001F2_A21ProdutoDescricao ;
      private string[] H001F2_A20ProdutoNome ;
      private short[] H001F2_A19ProdutoId ;
      private string[] H001F2_A68VendedorProdutoImagem ;
      private string[] H001F2_A23ProdutoImagem ;
   ...
   public class categoriaprodutowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6CategoriaProdutoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001F2", "SELECT T1.[CategoriaProdutoId], T2.[FornecedorNome] AS FornecedorProdutoNome, T1.[FornecedorProdutoId] AS FornecedorProdutoId, T3.[PaisNome] AS PaisProdutoNome, T1.[PaisProdutoId] AS PaisProdutoId, T4.[VendedorFoto_GXI] AS VendedorProdutoImagem_GXI, T4.[VendedorNome] AS VendedorProdutoNome, T1.[VendedorProdutoId] AS VendedorProdutoId, T1.[ProdutoImagem_GXI], T1.[ProdutoPreco], T1.[ProdutoDescricao], T1.[ProdutoNome], T1.[ProdutoId], T4.[VendedorFoto] AS VendedorProdutoImagem, T1.[ProdutoImagem] FROM ((([Produto] T1 INNER JOIN [Fornecedor] T2 ON T2.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisProdutoId]) INNER JOIN [Vendedor] T4 ON T4.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[CategoriaProdutoId] = @AV6CategoriaProdutoId ORDER BY T1.[CategoriaProdutoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001F3", "SELECT COUNT(*) FROM ((([Produto] T1 INNER JOIN [Fornecedor] T4 ON T4.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisProdutoId]) INNER JOIN [Vendedor] T2 ON T2.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[CategoriaProdutoId] = @AV6CategoriaProdutoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
