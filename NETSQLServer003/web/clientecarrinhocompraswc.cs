...
namespace GeneXus.Programs {
   public class clientecarrinhocompraswc : GXWebComponent
   {
      public clientecarrinhocompraswc( )
      {
      ...
      public clientecarrinhocompraswc( IGxContext context )
      {
      ...
      public void execute( short aP0_ClienteCarrinhoComprasId )
      {
         this.AV6ClienteCarrinhoComprasId = aP0_ClienteCarrinhoComprasId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "ClienteCarrinhoComprasId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ClienteCarrinhoComprasId = (short)(NumberUtil.Val( GetPar( "ClienteCarrinhoComprasId"), "."));
                  AssignAttri(sPrefix, false, "AV6ClienteCarrinhoComprasId", StringUtil.LTrimStr( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6ClienteCarrinhoComprasId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6ClienteCarrinhoComprasId, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "ClienteCarrinhoComprasWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Cliente Carrinho Compras WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientecarrinhocompraswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ClienteCarrinhoComprasId,4,0))}, new string[] {"ClienteCarrinhoComprasId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6ClienteCarrinhoComprasId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6ClienteCarrinhoComprasId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCLIENTECARRINHOCOMPRASID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0, ".", "")));
      ...
      {
         return "ClienteCarrinhoComprasWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente Carrinho Compras WC" ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientecarrinhocompraswc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClienteCarrinhoComprasWC.htm");
      ...
      protected void START0P2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Cliente Carrinho Compras WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       short AV6ClienteCarrinhoComprasId ,
                                       string AV12Update ,
                                       string AV13Delete ,
                                       string sPrefix )
      {
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARRINHOCOMPRASID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A52CarrinhoComprasId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CARRINHOCOMPRASID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A52CarrinhoComprasId), 4, 0, ".", "")));
      }
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000P3 */
            pr_default.execute(0, new Object[] {AV6ClienteCarrinhoComprasId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A54ClienteCarrinhoComprasId = H000P3_A54ClienteCarrinhoComprasId[0];
               AssignAttri(sPrefix, false, "A54ClienteCarrinhoComprasId", StringUtil.LTrimStr( (decimal)(A54ClienteCarrinhoComprasId), 4, 0));
               A52CarrinhoComprasId = H000P3_A52CarrinhoComprasId[0];
               A53CarrinhoComprasData = H000P3_A53CarrinhoComprasData[0];
               A62CarrinhoComprasPrecoTotal = H000P3_A62CarrinhoComprasPrecoTotal[0];
               n62CarrinhoComprasPrecoTotal = H000P3_n62CarrinhoComprasPrecoTotal[0];
               A62CarrinhoComprasPrecoTotal = H000P3_A62CarrinhoComprasPrecoTotal[0];
               n62CarrinhoComprasPrecoTotal = H000P3_n62CarrinhoComprasPrecoTotal[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARRINHOCOMPRASID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A52CarrinhoComprasId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H000P5 */
         pr_default.execute(1, new Object[] {AV6ClienteCarrinhoComprasId});
         GRID_nRecordCount = H000P5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ClienteCarrinhoComprasId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ClienteCarrinhoComprasId"), ".", ","));
      ...
      protected void E120P2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtClienteCarrinhoComprasId_Visible = 0;
         AssignProp(sPrefix, false, edtClienteCarrinhoComprasId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtClienteCarrinhoComprasId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "CarrinhoCompras";
         AV11TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ClienteCarrinhoComprasId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6ClienteCarrinhoComprasId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6ClienteCarrinhoComprasId", StringUtil.LTrimStr( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6ClienteCarrinhoComprasId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientecarrinhocompraswc", GetJustCreated( ));
         ...
         {
            AV6ClienteCarrinhoComprasId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6ClienteCarrinhoComprasId", StringUtil.LTrimStr( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0));
         }
         wcpOAV6ClienteCarrinhoComprasId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ClienteCarrinhoComprasId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6ClienteCarrinhoComprasId != wcpOAV6ClienteCarrinhoComprasId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6ClienteCarrinhoComprasId = AV6ClienteCarrinhoComprasId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6ClienteCarrinhoComprasId = cgiGet( sPrefix+"AV6ClienteCarrinhoComprasId_CTRL");
         if ( StringUtil.Len( sCtrlAV6ClienteCarrinhoComprasId) > 0 )
         {
            AV6ClienteCarrinhoComprasId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6ClienteCarrinhoComprasId), ".", ","));
            AssignAttri(sPrefix, false, "AV6ClienteCarrinhoComprasId", StringUtil.LTrimStr( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0));
         }
         else
         {
            AV6ClienteCarrinhoComprasId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6ClienteCarrinhoComprasId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6ClienteCarrinhoComprasId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ClienteCarrinhoComprasId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6ClienteCarrinhoComprasId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6ClienteCarrinhoComprasId_CTRL", StringUtil.RTrim( sCtrlAV6ClienteCarrinhoComprasId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513778", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientecarrinhocompraswc.js", "?202582916513778", false, true);
         }
      ...
      {
         edtCarrinhoComprasId_Internalname = sPrefix+"CARRINHOCOMPRASID_"+sGXsfl_22_idx;
         edtCarrinhoComprasData_Internalname = sPrefix+"CARRINHOCOMPRASDATA_"+sGXsfl_22_idx;
         edtCarrinhoComprasPrecoTotal_Internalname = sPrefix+"CARRINHOCOMPRASPRECOTOTAL_"+sGXsfl_22_idx;
         edtCarrinhoComprasDataEntrega_Internalname = sPrefix+"CARRINHOCOMPRASDATAENTREGA_"+sGXsfl_22_idx;
         edtCarrinhoComprasPontos_Internalname = sPrefix+"CARRINHOCOMPRASPONTOS_"+sGXsfl_22_idx;
      ...
      {
         edtCarrinhoComprasId_Internalname = sPrefix+"CARRINHOCOMPRASID_"+sGXsfl_22_fel_idx;
         edtCarrinhoComprasData_Internalname = sPrefix+"CARRINHOCOMPRASDATA_"+sGXsfl_22_fel_idx;
         edtCarrinhoComprasPrecoTotal_Internalname = sPrefix+"CARRINHOCOMPRASPRECOTOTAL_"+sGXsfl_22_fel_idx;
         edtCarrinhoComprasDataEntrega_Internalname = sPrefix+"CARRINHOCOMPRASDATAENTREGA_"+sGXsfl_22_fel_idx;
         edtCarrinhoComprasPontos_Internalname = sPrefix+"CARRINHOCOMPRASPONTOS_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCarrinhoComprasDataEntrega_Internalname,context.localUtil.Format(A63CarrinhoComprasDataEntrega, "99/99/99"),context.localUtil.Format( A63CarrinhoComprasDataEntrega, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCarrinhoComprasDataEntrega_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCarrinhoComprasPontos_Internalname,StringUtil.LTrim( StringUtil.NToC( A65CarrinhoComprasPontos, 10, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A65CarrinhoComprasPontos, "ZZZZZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCarrinhoComprasPontos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void initialize_properties( )
      {
         ...
         edtClienteCarrinhoComprasId_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ClienteCarrinhoComprasId',fld:'vCLIENTECARRINHOCOMPRASID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130P2',iparms:[{av:'A52CarrinhoComprasId',fld:'CARRINHOCOMPRASID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110P2',iparms:[{av:'A52CarrinhoComprasId',fld:'CARRINHOCOMPRASID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ClienteCarrinhoComprasId',fld:'vCLIENTECARRINHOCOMPRASID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ClienteCarrinhoComprasId',fld:'vCLIENTECARRINHOCOMPRASID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ClienteCarrinhoComprasId',fld:'vCLIENTECARRINHOCOMPRASID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ClienteCarrinhoComprasId',fld:'vCLIENTECARRINHOCOMPRASID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000P3_A54ClienteCarrinhoComprasId = new short[1] ;
         H000P3_A52CarrinhoComprasId = new short[1] ;
         H000P3_A53CarrinhoComprasData = new DateTime[] {DateTime.MinValue} ;
         H000P3_A62CarrinhoComprasPrecoTotal = new decimal[1] ;
         H000P3_n62CarrinhoComprasPrecoTotal = new bool[] {false} ;
         H000P5_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6ClienteCarrinhoComprasId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientecarrinhocompraswc__default(),
            new Object[][] {
                new Object[] {
               H000P3_A54ClienteCarrinhoComprasId, H000P3_A52CarrinhoComprasId, H000P3_A53CarrinhoComprasData, H000P3_A62CarrinhoComprasPrecoTotal, H000P3_n62CarrinhoComprasPrecoTotal
               }
               , new Object[] {
               H000P5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ClienteCarrinhoComprasWC";
      ...
      private short AV6ClienteCarrinhoComprasId ;
      private short wcpOAV6ClienteCarrinhoComprasId ;
      ...
      private int edtClienteCarrinhoComprasId_Visible ;
      ...
      private string sCtrlAV6ClienteCarrinhoComprasId ;
      ...
      private short[] H000P3_A54ClienteCarrinhoComprasId ;
      private short[] H000P3_A52CarrinhoComprasId ;
      private DateTime[] H000P3_A53CarrinhoComprasData ;
      private decimal[] H000P3_A62CarrinhoComprasPrecoTotal ;
      private bool[] H000P3_n62CarrinhoComprasPrecoTotal ;
      private long[] H000P5_AGRID_nRecordCount ;
   ...
   public class clientecarrinhocompraswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6ClienteCarrinhoComprasId",GXType.Int16,4,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH000P5;
          prmH000P5 = new Object[] {
          new ParDef("@AV6ClienteCarrinhoComprasId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H000P3", "SELECT T1.[ClienteCarrinhoComprasId], T1.[CarrinhoComprasId], T1.[CarrinhoComprasData], COALESCE( T2.[CarrinhoComprasPrecoTotal], 0) AS CarrinhoComprasPrecoTotal FROM ([CarrinhoCompras] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T5.[CategoriaNome] = 'Joalheria' THEN ( T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) * CAST(1.05 AS decimal( 22, 10))) WHEN T5.[CategoriaNome] = 'Entreterimento' THEN ( T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) * CAST(0.9 AS decimal( 22, 10))) ELSE T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) END) AS CarrinhoComprasPrecoTotal, T3.[CarrinhoComprasId] FROM (([CarrinhoComprasProdutos] T3 INNER JOIN [Produto] T4 ON T4.[ProdutoId] = T3.[ProdutoId]) INNER JOIN [Categoria] T5 ON T5.[CategoriaId] = T4.[CategoriaProdutoId]) GROUP BY T3.[CarrinhoComprasId] ) T2 ON T2.[CarrinhoComprasId] = T1.[CarrinhoComprasId]) WHERE T1.[ClienteCarrinhoComprasId] = @AV6ClienteCarrinhoComprasId ORDER BY T1.[ClienteCarrinhoComprasId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000P5", "SELECT COUNT(*) FROM ([CarrinhoCompras] T1 LEFT JOIN (SELECT SUM(CASE  WHEN T5.[CategoriaNome] = 'Joalheria' THEN ( T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) * CAST(1.05 AS decimal( 22, 10))) WHEN T5.[CategoriaNome] = 'Entreterimento' THEN ( T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) * CAST(0.9 AS decimal( 22, 10))) ELSE T3.[CarrinhoComprasProdutosQuantid] * CAST(T4.[ProdutoPreco] AS decimal( 20, 10)) END) AS CarrinhoComprasPrecoTotal, T3.[CarrinhoComprasId] FROM (([CarrinhoComprasProdutos] T3 INNER JOIN [Produto] T4 ON T4.[ProdutoId] = T3.[ProdutoId]) INNER JOIN [Categoria] T5 ON T5.[CategoriaId] = T4.[CategoriaProdutoId]) GROUP BY T3.[CarrinhoComprasId] ) T2 ON T2.[CarrinhoComprasId] = T1.[CarrinhoComprasId]) WHERE T1.[ClienteCarrinhoComprasId] = @AV6ClienteCarrinhoComprasId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
