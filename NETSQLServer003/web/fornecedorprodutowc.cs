...
namespace GeneXus.Programs {
   public class fornecedorprodutowc : GXWebComponent
   {
      public fornecedorprodutowc( )
      {
      ...
      public fornecedorprodutowc( IGxContext context )
      {
      ...
      public void execute( short aP0_FornecedorProdutoId )
      {
         this.AV6FornecedorProdutoId = aP0_FornecedorProdutoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "FornecedorProdutoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6FornecedorProdutoId = (short)(NumberUtil.Val( GetPar( "FornecedorProdutoId"), "."));
                  AssignAttri(sPrefix, false, "AV6FornecedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6FornecedorProdutoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6FornecedorProdutoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6FornecedorProdutoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "FornecedorProdutoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Fornecedor Produto WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("fornecedorprodutowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6FornecedorProdutoId,4,0))}, new string[] {"FornecedorProdutoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6FornecedorProdutoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6FornecedorProdutoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vFORNECEDORPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6FornecedorProdutoId), 4, 0, ".", "")));
      ...
      {
         return "FornecedorProdutoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Fornecedor Produto WC" ;
      }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "fornecedorprodutowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_FornecedorProdutoWC.htm");
      ...
      protected void START1I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Fornecedor Produto WC", 0) ;
            }
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
                              ...
                              AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUTOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A19ProdutoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A19ProdutoId), 4, 0, ".", "")));
      }
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001I2 */
            pr_default.execute(0, new Object[] {AV6FornecedorProdutoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A28FornecedorProdutoId = H001I2_A28FornecedorProdutoId[0];
               AssignAttri(sPrefix, false, "A28FornecedorProdutoId", StringUtil.LTrimStr( (decimal)(A28FornecedorProdutoId), 4, 0));
               A31CategoriaProdutoNome = H001I2_A31CategoriaProdutoNome[0];
               A30CategoriaProdutoId = H001I2_A30CategoriaProdutoId[0];
               A27PaisProdutoNome = H001I2_A27PaisProdutoNome[0];
               A26PaisProdutoId = H001I2_A26PaisProdutoId[0];
               A40001VendedorProdutoImagem_GXI = H001I2_A40001VendedorProdutoImagem_GXI[0];
               n40001VendedorProdutoImagem_GXI = H001I2_n40001VendedorProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A25VendedorProdutoNome = H001I2_A25VendedorProdutoNome[0];
               A24VendedorProdutoId = H001I2_A24VendedorProdutoId[0];
               A40000ProdutoImagem_GXI = H001I2_A40000ProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A22ProdutoPreco = H001I2_A22ProdutoPreco[0];
               A21ProdutoDescricao = H001I2_A21ProdutoDescricao[0];
               A20ProdutoNome = H001I2_A20ProdutoNome[0];
               A19ProdutoId = H001I2_A19ProdutoId[0];
               A68VendedorProdutoImagem = H001I2_A68VendedorProdutoImagem[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A23ProdutoImagem = H001I2_A23ProdutoImagem[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A31CategoriaProdutoNome = H001I2_A31CategoriaProdutoNome[0];
               A27PaisProdutoNome = H001I2_A27PaisProdutoNome[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUTOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A19ProdutoId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H001I3 */
         pr_default.execute(1, new Object[] {AV6FornecedorProdutoId});
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6FornecedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6FornecedorProdutoId"), ".", ","));
      ...
      protected void E121I2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtFornecedorProdutoId_Visible = 0;
         AssignProp(sPrefix, false, edtFornecedorProdutoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtFornecedorProdutoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Produto";
         AV11TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "FornecedorProdutoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6FornecedorProdutoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6FornecedorProdutoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6FornecedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6FornecedorProdutoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6FornecedorProdutoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "fornecedorprodutowc", GetJustCreated( ));
         ...
         {
            AV6FornecedorProdutoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6FornecedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6FornecedorProdutoId), 4, 0));
         }
         wcpOAV6FornecedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6FornecedorProdutoId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6FornecedorProdutoId != wcpOAV6FornecedorProdutoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6FornecedorProdutoId = AV6FornecedorProdutoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6FornecedorProdutoId = cgiGet( sPrefix+"AV6FornecedorProdutoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6FornecedorProdutoId) > 0 )
         {
            AV6FornecedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6FornecedorProdutoId), ".", ","));
            AssignAttri(sPrefix, false, "AV6FornecedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6FornecedorProdutoId), 4, 0));
         }
         else
         {
            AV6FornecedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6FornecedorProdutoId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6FornecedorProdutoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6FornecedorProdutoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6FornecedorProdutoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6FornecedorProdutoId_CTRL", StringUtil.RTrim( sCtrlAV6FornecedorProdutoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513572", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("fornecedorprodutowc.js", "?202582916513572", false, true);
         }
      ...
      {
         edtProdutoId_Internalname = sPrefix+"PRODUTOID_"+sGXsfl_22_idx;
         edtProdutoNome_Internalname = sPrefix+"PRODUTONOME_"+sGXsfl_22_idx;
         edtProdutoDescricao_Internalname = sPrefix+"PRODUTODESCRICAO_"+sGXsfl_22_idx;
         edtProdutoPreco_Internalname = sPrefix+"PRODUTOPRECO_"+sGXsfl_22_idx;
         edtProdutoImagem_Internalname = sPrefix+"PRODUTOIMAGEM_"+sGXsfl_22_idx;
         edtVendedorProdutoId_Internalname = sPrefix+"VENDEDORPRODUTOID_"+sGXsfl_22_idx;
         edtVendedorProdutoNome_Internalname = sPrefix+"VENDEDORPRODUTONOME_"+sGXsfl_22_idx;
         edtVendedorProdutoImagem_Internalname = sPrefix+"VENDEDORPRODUTOIMAGEM_"+sGXsfl_22_idx;
         edtPaisProdutoId_Internalname = sPrefix+"PAISPRODUTOID_"+sGXsfl_22_idx;
         edtPaisProdutoNome_Internalname = sPrefix+"PAISPRODUTONOME_"+sGXsfl_22_idx;
         edtCategoriaProdutoId_Internalname = sPrefix+"CATEGORIAPRODUTOID_"+sGXsfl_22_idx;
         edtCategoriaProdutoNome_Internalname = sPrefix+"CATEGORIAPRODUTONOME_"+sGXsfl_22_idx;
      ...
      {
         edtProdutoId_Internalname = sPrefix+"PRODUTOID_"+sGXsfl_22_fel_idx;
         edtProdutoNome_Internalname = sPrefix+"PRODUTONOME_"+sGXsfl_22_fel_idx;
         edtProdutoDescricao_Internalname = sPrefix+"PRODUTODESCRICAO_"+sGXsfl_22_fel_idx;
         edtProdutoPreco_Internalname = sPrefix+"PRODUTOPRECO_"+sGXsfl_22_fel_idx;
         edtProdutoImagem_Internalname = sPrefix+"PRODUTOIMAGEM_"+sGXsfl_22_fel_idx;
         edtVendedorProdutoId_Internalname = sPrefix+"VENDEDORPRODUTOID_"+sGXsfl_22_fel_idx;
         edtVendedorProdutoNome_Internalname = sPrefix+"VENDEDORPRODUTONOME_"+sGXsfl_22_fel_idx;
         edtVendedorProdutoImagem_Internalname = sPrefix+"VENDEDORPRODUTOIMAGEM_"+sGXsfl_22_fel_idx;
         edtPaisProdutoId_Internalname = sPrefix+"PAISPRODUTOID_"+sGXsfl_22_fel_idx;
         edtPaisProdutoNome_Internalname = sPrefix+"PAISPRODUTONOME_"+sGXsfl_22_fel_idx;
         edtCategoriaProdutoId_Internalname = sPrefix+"CATEGORIAPRODUTOID_"+sGXsfl_22_fel_idx;
         edtCategoriaProdutoNome_Internalname = sPrefix+"CATEGORIAPRODUTONOME_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProdutoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A19ProdutoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A19ProdutoId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProdutoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaProdutoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A30CategoriaProdutoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A30CategoriaProdutoId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoriaProdutoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaProdutoNome_Internalname,(string)A31CategoriaProdutoNome,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoriaProdutoNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtProdutoImagem_Internalname = sPrefix+"PRODUTOIMAGEM";
         ...
         edtVendedorProdutoImagem_Internalname = sPrefix+"VENDEDORPRODUTOIMAGEM";
      ...
      public override void initialize_properties( )
      {
         ...
         edtFornecedorProdutoId_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FornecedorProdutoId',fld:'vFORNECEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131I2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111I2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FornecedorProdutoId',fld:'vFORNECEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FornecedorProdutoId',fld:'vFORNECEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FornecedorProdutoId',fld:'vFORNECEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FornecedorProdutoId',fld:'vFORNECEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001I2_A28FornecedorProdutoId = new short[1] ;
         H001I2_A31CategoriaProdutoNome = new string[] {""} ;
         H001I2_A30CategoriaProdutoId = new short[1] ;
         H001I2_A27PaisProdutoNome = new string[] {""} ;
         H001I2_A26PaisProdutoId = new short[1] ;
         H001I2_A40001VendedorProdutoImagem_GXI = new string[] {""} ;
         H001I2_n40001VendedorProdutoImagem_GXI = new bool[] {false} ;
         H001I2_A25VendedorProdutoNome = new string[] {""} ;
         H001I2_A24VendedorProdutoId = new short[1] ;
         H001I2_A40000ProdutoImagem_GXI = new string[] {""} ;
         H001I2_A22ProdutoPreco = new decimal[1] ;
         H001I2_A21ProdutoDescricao = new string[] {""} ;
         H001I2_A20ProdutoNome = new string[] {""} ;
         H001I2_A19ProdutoId = new short[1] ;
         H001I2_A68VendedorProdutoImagem = new string[] {""} ;
         H001I2_A23ProdutoImagem = new string[] {""} ;
         ...
         sCtrlAV6FornecedorProdutoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.fornecedorprodutowc__default(),
            new Object[][] {
                new Object[] {
               H001I2_A28FornecedorProdutoId, H001I2_A31CategoriaProdutoNome, H001I2_A30CategoriaProdutoId, H001I2_A27PaisProdutoNome, H001I2_A26PaisProdutoId, H001I2_A40001VendedorProdutoImagem_GXI, H001I2_n40001VendedorProdutoImagem_GXI, H001I2_A25VendedorProdutoNome, H001I2_A24VendedorProdutoId, H001I2_A40000ProdutoImagem_GXI,
               H001I2_A22ProdutoPreco, H001I2_A21ProdutoDescricao, H001I2_A20ProdutoNome, H001I2_A19ProdutoId, H001I2_A68VendedorProdutoImagem, H001I2_A23ProdutoImagem
               }
               , new Object[] {
      ...
      private short AV6FornecedorProdutoId ;
      private short wcpOAV6FornecedorProdutoId ;
      ...
      private int edtFornecedorProdutoId_Visible ;
      ...
      private string sCtrlAV6FornecedorProdutoId ;
      ...
      private short[] H001I2_A28FornecedorProdutoId ;
      private string[] H001I2_A31CategoriaProdutoNome ;
      private short[] H001I2_A30CategoriaProdutoId ;
      private string[] H001I2_A27PaisProdutoNome ;
      private short[] H001I2_A26PaisProdutoId ;
      private string[] H001I2_A40001VendedorProdutoImagem_GXI ;
      private bool[] H001I2_n40001VendedorProdutoImagem_GXI ;
      private string[] H001I2_A25VendedorProdutoNome ;
      private short[] H001I2_A24VendedorProdutoId ;
      private string[] H001I2_A40000ProdutoImagem_GXI ;
      private decimal[] H001I2_A22ProdutoPreco ;
      private string[] H001I2_A21ProdutoDescricao ;
      private string[] H001I2_A20ProdutoNome ;
      private short[] H001I2_A19ProdutoId ;
      private string[] H001I2_A68VendedorProdutoImagem ;
      private string[] H001I2_A23ProdutoImagem ;
   ...
   public class fornecedorprodutowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6FornecedorProdutoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001I2", "SELECT T1.[FornecedorProdutoId], T2.[CategoriaNome] AS CategoriaProdutoNome, T1.[CategoriaProdutoId] AS CategoriaProdutoId, T3.[PaisNome] AS PaisProdutoNome, T1.[PaisProdutoId] AS PaisProdutoId, T4.[VendedorFoto_GXI] AS VendedorProdutoImagem_GXI, T4.[VendedorNome] AS VendedorProdutoNome, T1.[VendedorProdutoId] AS VendedorProdutoId, T1.[ProdutoImagem_GXI], T1.[ProdutoPreco], T1.[ProdutoDescricao], T1.[ProdutoNome], T1.[ProdutoId], T4.[VendedorFoto] AS VendedorProdutoImagem, T1.[ProdutoImagem] FROM ((([Produto] T1 INNER JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisProdutoId]) INNER JOIN [Vendedor] T4 ON T4.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[FornecedorProdutoId] = @AV6FornecedorProdutoId ORDER BY T1.[FornecedorProdutoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001I3", "SELECT COUNT(*) FROM ((([Produto] T1 INNER JOIN [Categoria] T4 ON T4.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisProdutoId]) INNER JOIN [Vendedor] T2 ON T2.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[FornecedorProdutoId] = @AV6FornecedorProdutoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[14])[0] = rslt.getMultimediaFile(14, rslt.getVarchar(6));
