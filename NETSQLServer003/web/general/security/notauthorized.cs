...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea
   {
      ...
      protected void wb_table1_3_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_0E2( true) ;
         }
         else
         {
            wb_table2_12_0E2( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_0E2( true) ;
         }
         else
         {
            wb_table3_15_0E2( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_0E2e( true) ;
         }
         else
         {
            wb_table3_15_0E2e( false) ;
         }
      }

      protected void wb_table2_12_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_0E2e( true) ;
         }
         else
         {
            wb_table2_12_0E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513813", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?202582916513813", false, true);
