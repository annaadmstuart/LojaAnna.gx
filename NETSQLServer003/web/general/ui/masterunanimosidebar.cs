...
namespace GeneXus.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?202582916513813", false, true);
      ...
      protected void WB010( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 24, "px", "", "left", "top", "", "align-self:center;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "min-height:20;", "div");
            /* Static images/pictures */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "Loja online www.lojaonline.com", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, 0, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton1_Internalname, "", "Vendedores e produtos", bttButton1_Jsonclick, 7, "Vendedores e produtos", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e11011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton7_Internalname, "", "Incrementar preço", bttButton7_Jsonclick, 7, "Incrementar preço", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e12011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton2_Internalname, "", "Cliente e data de compras", bttButton2_Jsonclick, 7, "Cliente e data de compras", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e13011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton6_Internalname, "", "Principal", bttButton6_Jsonclick, 7, "Principal", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e14011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton3_Internalname, "", "Categorias e Produto", bttButton3_Jsonclick, 7, "Categorias e Produto", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e15011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton4_Internalname, "", "Quantidade de compras", bttButton4_Jsonclick, 7, "Quantidade de compras", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e16011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton5_Internalname, "", "Produtos por Pais", bttButton5_Jsonclick, 7, "Produtos por Pais", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e17011_client"+"'", TempTags, "", 2, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP010( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Sidebarmenu_Distancetotop = (int)(context.localUtil.CToN( cgiGet( "SIDEBARMENU_MPAGE_Distancetotop"), ".", ","));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202582916513825", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?202582916513825", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttButton6_Internalname = "BUTTON6_MPAGE";
         bttButton3_Internalname = "BUTTON3_MPAGE";
         bttButton4_Internalname = "BUTTON4_MPAGE";
         bttButton5_Internalname = "BUTTON5_MPAGE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VENDEDORES_MPAGE","{handler:'E11011',iparms:[]");
         setEventMetadata("VENDEDORES_MPAGE",",oparms:[]}");
         setEventMetadata("CARRINHO_MPAGE","{handler:'E13011',iparms:[]");
         setEventMetadata("CARRINHO_MPAGE",",oparms:[]}");
         setEventMetadata("PRINCIPAL_MPAGE","{handler:'E14011',iparms:[]");
         setEventMetadata("PRINCIPAL_MPAGE",",oparms:[]}");
         setEventMetadata("INCREMENTAR_MPAGE","{handler:'E12011',iparms:[]");
         setEventMetadata("INCREMENTAR_MPAGE",",oparms:[]}");
         setEventMetadata("QUANTIDADE_MPAGE","{handler:'E16011',iparms:[]");
         setEventMetadata("QUANTIDADE_MPAGE",",oparms:[]}");
         setEventMetadata("PRODUTOSPAIS_MPAGE","{handler:'E17011',iparms:[]");
         setEventMetadata("PRODUTOSPAIS_MPAGE",",oparms:[]}");
         setEventMetadata("CATEGORIAPRODUTO_MPAGE","{handler:'E15011',iparms:[]");
         setEventMetadata("CATEGORIAPRODUTO_MPAGE",",oparms:[]}");
         return  ;
      }
