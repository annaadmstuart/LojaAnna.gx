/*
			...
			Description: Attributes
				 Author: Nemo 🐠 for C# (.NET) version 18.0.0.166471
...
namespace GeneXus.Programs.general.ui
{
	...
	[XmlType(TypeName="TransactionContext.Attribute" , Namespace="LojaAnnaLaisa1" )]
	[Serializable]
	...
	[DataContract(Name=@"TransactionContext.Attribute", Namespace="LojaAnnaLaisa1")]
