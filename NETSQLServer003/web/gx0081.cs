...
namespace GeneXus.Programs {
   public class gx0081 : GXDataArea
   {
      ...
      public void execute( short aP0_pPromocaoId ,
                           out short aP1_pProdutoId )
      {
         this.AV7pPromocaoId = aP0_pPromocaoId;
         this.AV8pProdutoId = 0 ;
         executePrivate();
         aP1_pProdutoId=this.AV8pProdutoId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV7pPromocaoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7pPromocaoId", StringUtil.LTrimStr( (decimal)(AV7pPromocaoId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pProdutoId = (short)(NumberUtil.Val( GetPar( "pProdutoId"), "."));
                  AssignAttri("", false, "AV8pProdutoId", StringUtil.LTrimStr( (decimal)(AV8pProdutoId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7pPromocaoId = (short)(NumberUtil.Val( GetPar( "pPromocaoId"), "."));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProdutoId, AV7pPromocaoId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0081.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromocaoId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProdutoId,4,0))}, new string[] {"pPromocaoId","pProdutoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPPROMOCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pPromocaoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pProdutoId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx0081.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromocaoId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProdutoId,4,0))}, new string[] {"pPromocaoId","pProdutoId"})  ;
      }
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprodutoidfilter_Internalname, "Produto", "", "", lblLblprodutoidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11091_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0081.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12091_client"+"'", TempTags, "", 2, "HLP_Gx0081.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void RF092( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00092 */
            pr_default.execute(0, new Object[] {AV7pPromocaoId, AV6cProdutoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A32PromocaoId = H00092_A32PromocaoId[0];
               A19ProdutoId = H00092_A19ProdutoId[0];
               /* Execute user event: Load */
               E14092 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUTOID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A19ProdutoId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H00093 */
         pr_default.execute(1, new Object[] {AV7pPromocaoId, AV6cProdutoId});
      ...
      protected void E15092( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pProdutoId = A19ProdutoId;
         AssignAttri("", false, "AV8pProdutoId", StringUtil.LTrimStr( (decimal)(AV8pProdutoId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV8pProdutoId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pProdutoId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pPromocaoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pPromocaoId", StringUtil.LTrimStr( (decimal)(AV7pPromocaoId), 4, 0));
         AV8pProdutoId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV8pProdutoId", StringUtil.LTrimStr( (decimal)(AV8pProdutoId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916514311", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0081.js", "?202582916514311", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtProdutoId_Internalname = "PRODUTOID_"+sGXsfl_24_idx;
         edtPromocaoId_Internalname = "PROMOCAOID_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx;
         edtProdutoId_Internalname = "PRODUTOID_"+sGXsfl_24_fel_idx;
         edtPromocaoId_Internalname = "PROMOCAOID_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtProdutoId_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize_properties( )
      {
         ...
         divProdutoidfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProdutoId',fld:'vCPRODUTOID',pic:'ZZZ9'},{av:'AV7pPromocaoId',fld:'vPPROMOCAOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("LBLPRODUTOIDFILTER.CLICK","{handler:'E11091',iparms:[{av:'divProdutoidfiltercontainer_Class',ctrl:'PRODUTOIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E15092',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pProdutoId',fld:'vPPRODUTOID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProdutoId',fld:'vCPRODUTOID',pic:'ZZZ9'},{av:'AV7pPromocaoId',fld:'vPPROMOCAOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProdutoId',fld:'vCPRODUTOID',pic:'ZZZ9'},{av:'AV7pPromocaoId',fld:'vPPROMOCAOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProdutoId',fld:'vCPRODUTOID',pic:'ZZZ9'},{av:'AV7pPromocaoId',fld:'vPPROMOCAOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProdutoId',fld:'vCPRODUTOID',pic:'ZZZ9'},{av:'AV7pPromocaoId',fld:'vPPROMOCAOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Promocaoid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00092_A32PromocaoId = new short[1] ;
         H00092_A19ProdutoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0081__default(),
            new Object[][] {
                new Object[] {
               H00092_A32PromocaoId, H00092_A19ProdutoId
               }
               , new Object[] {
      ...
      private short AV7pPromocaoId ;
      private short AV8pProdutoId ;
      private short wcpOAV7pPromocaoId ;
      ...
      private string edtProdutoId_Link ;
      ...
      private short[] H00092_A32PromocaoId ;
      private short[] H00092_A19ProdutoId ;
   ...
   public class gx0081__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7pPromocaoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00092", "SELECT [PromocaoId], [ProdutoId] FROM [PromocaoProduto] WHERE [PromocaoId] = @AV7pPromocaoId and [ProdutoId] >= @AV6cProdutoId ORDER BY [PromocaoId], [ProdutoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00092,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00093", "SELECT COUNT(*) FROM [PromocaoProduto] WHERE [PromocaoId] = @AV7pPromocaoId and [ProdutoId] >= @AV6cProdutoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00093,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
