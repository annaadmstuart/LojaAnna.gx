		...
		return {
			...
			html5: function (root) {
				var browser = gx.util.browser,
					isIE = browser.isIE(),
					i,
					styleBuffer = [`@layer ${DOM_FIXES_STYLE_ID} {`],
					styleEl;
			...
			fixTableResets: function (root) {
				...
				gx.dom.setStyleElement(styleEl, `@layer ${DOM_FIXES_STYLE_ID} { ${Mustache.render(cellPaddingsTemplate, newCellPaddings)}${Mustache.render(cellSpacingsTemplate, newCellSpacings)} }`, true);
			},
