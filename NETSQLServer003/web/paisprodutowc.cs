...
namespace GeneXus.Programs {
   public class paisprodutowc : GXWebComponent
   {
      public paisprodutowc( )
      {
      ...
      public paisprodutowc( IGxContext context )
      {
      ...
      public void execute( short aP0_PaisProdutoId )
      {
         this.AV6PaisProdutoId = aP0_PaisProdutoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "PaisProdutoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6PaisProdutoId = (short)(NumberUtil.Val( GetPar( "PaisProdutoId"), "."));
                  AssignAttri(sPrefix, false, "AV6PaisProdutoId", StringUtil.LTrimStr( (decimal)(AV6PaisProdutoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6PaisProdutoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6PaisProdutoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Pais Produto WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisprodutowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PaisProdutoId,4,0))}, new string[] {"PaisProdutoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6PaisProdutoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6PaisProdutoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPAISPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisProdutoId), 4, 0, ".", "")));
      ...
      {
         return "PaisProdutoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Pais Produto WC" ;
      }
      ...
      protected void WB1M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paisprodutowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisProdutoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_label_element( context, edtPaisProdutoId_Internalname, "País", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisProdutoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A26PaisProdutoId), 4, 0, ".", "")), StringUtil.LTrim( ((edtPaisProdutoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A26PaisProdutoId), "ZZZ9") : context.localUtil.Format( (decimal)(A26PaisProdutoId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisProdutoId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisProdutoId_Visible, edtPaisProdutoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_PaisProdutoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1M2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Pais Produto WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001M2 */
            pr_default.execute(0, new Object[] {AV6PaisProdutoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A26PaisProdutoId = H001M2_A26PaisProdutoId[0];
               AssignAttri(sPrefix, false, "A26PaisProdutoId", StringUtil.LTrimStr( (decimal)(A26PaisProdutoId), 4, 0));
               A31CategoriaProdutoNome = H001M2_A31CategoriaProdutoNome[0];
               A30CategoriaProdutoId = H001M2_A30CategoriaProdutoId[0];
               A29FornecedorProdutoNome = H001M2_A29FornecedorProdutoNome[0];
               A28FornecedorProdutoId = H001M2_A28FornecedorProdutoId[0];
               A40001VendedorProdutoImagem_GXI = H001M2_A40001VendedorProdutoImagem_GXI[0];
               n40001VendedorProdutoImagem_GXI = H001M2_n40001VendedorProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A25VendedorProdutoNome = H001M2_A25VendedorProdutoNome[0];
               A24VendedorProdutoId = H001M2_A24VendedorProdutoId[0];
               A40000ProdutoImagem_GXI = H001M2_A40000ProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A22ProdutoPreco = H001M2_A22ProdutoPreco[0];
               A21ProdutoDescricao = H001M2_A21ProdutoDescricao[0];
               A20ProdutoNome = H001M2_A20ProdutoNome[0];
               A19ProdutoId = H001M2_A19ProdutoId[0];
               A68VendedorProdutoImagem = H001M2_A68VendedorProdutoImagem[0];
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A68VendedorProdutoImagem)) ? A40001VendedorProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A68VendedorProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtVendedorProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A68VendedorProdutoImagem), true);
               A23ProdutoImagem = H001M2_A23ProdutoImagem[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A31CategoriaProdutoNome = H001M2_A31CategoriaProdutoNome[0];
               A29FornecedorProdutoNome = H001M2_A29FornecedorProdutoNome[0];
      ...
      {
         /* Using cursor H001M3 */
         pr_default.execute(1, new Object[] {AV6PaisProdutoId});
      ...
      protected void STRUP1M0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PaisProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisProdutoId"), ".", ","));
      ...
      protected void E121M2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtPaisProdutoId_Visible = 0;
         AssignProp(sPrefix, false, edtPaisProdutoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtPaisProdutoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "PaisProdutoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6PaisProdutoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6PaisProdutoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6PaisProdutoId", StringUtil.LTrimStr( (decimal)(AV6PaisProdutoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6PaisProdutoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paisprodutowc", GetJustCreated( ));
         ...
         {
            AV6PaisProdutoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6PaisProdutoId", StringUtil.LTrimStr( (decimal)(AV6PaisProdutoId), 4, 0));
         }
         wcpOAV6PaisProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisProdutoId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6PaisProdutoId != wcpOAV6PaisProdutoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6PaisProdutoId = AV6PaisProdutoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6PaisProdutoId = cgiGet( sPrefix+"AV6PaisProdutoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6PaisProdutoId) > 0 )
         {
            AV6PaisProdutoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6PaisProdutoId), ".", ","));
            AssignAttri(sPrefix, false, "AV6PaisProdutoId", StringUtil.LTrimStr( (decimal)(AV6PaisProdutoId), 4, 0));
         }
         else
         {
            AV6PaisProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6PaisProdutoId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6PaisProdutoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisProdutoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6PaisProdutoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6PaisProdutoId_CTRL", StringUtil.RTrim( sCtrlAV6PaisProdutoId));
         }
      }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paisprodutowc.js", "?202582916513688", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtFornecedorProdutoId_Internalname = sPrefix+"FORNECEDORPRODUTOID_"+sGXsfl_22_idx;
         edtFornecedorProdutoNome_Internalname = sPrefix+"FORNECEDORPRODUTONOME_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtFornecedorProdutoId_Internalname = sPrefix+"FORNECEDORPRODUTOID_"+sGXsfl_22_fel_idx;
         edtFornecedorProdutoNome_Internalname = sPrefix+"FORNECEDORPRODUTONOME_"+sGXsfl_22_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisProdutoId',fld:'vPAISPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131M2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111M2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisProdutoId',fld:'vPAISPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisProdutoId',fld:'vPAISPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisProdutoId',fld:'vPAISPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisProdutoId',fld:'vPAISPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001M2_A26PaisProdutoId = new short[1] ;
         H001M2_A31CategoriaProdutoNome = new string[] {""} ;
         H001M2_A30CategoriaProdutoId = new short[1] ;
         H001M2_A29FornecedorProdutoNome = new string[] {""} ;
         H001M2_A28FornecedorProdutoId = new short[1] ;
         H001M2_A40001VendedorProdutoImagem_GXI = new string[] {""} ;
         H001M2_n40001VendedorProdutoImagem_GXI = new bool[] {false} ;
         H001M2_A25VendedorProdutoNome = new string[] {""} ;
         H001M2_A24VendedorProdutoId = new short[1] ;
         H001M2_A40000ProdutoImagem_GXI = new string[] {""} ;
         H001M2_A22ProdutoPreco = new decimal[1] ;
         H001M2_A21ProdutoDescricao = new string[] {""} ;
         H001M2_A20ProdutoNome = new string[] {""} ;
         H001M2_A19ProdutoId = new short[1] ;
         H001M2_A68VendedorProdutoImagem = new string[] {""} ;
         H001M2_A23ProdutoImagem = new string[] {""} ;
         ...
         sCtrlAV6PaisProdutoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisprodutowc__default(),
            new Object[][] {
                new Object[] {
               H001M2_A26PaisProdutoId, H001M2_A31CategoriaProdutoNome, H001M2_A30CategoriaProdutoId, H001M2_A29FornecedorProdutoNome, H001M2_A28FornecedorProdutoId, H001M2_A40001VendedorProdutoImagem_GXI, H001M2_n40001VendedorProdutoImagem_GXI, H001M2_A25VendedorProdutoNome, H001M2_A24VendedorProdutoId, H001M2_A40000ProdutoImagem_GXI,
               H001M2_A22ProdutoPreco, H001M2_A21ProdutoDescricao, H001M2_A20ProdutoNome, H001M2_A19ProdutoId, H001M2_A68VendedorProdutoImagem, H001M2_A23ProdutoImagem
               }
               , new Object[] {
      ...
      private short AV6PaisProdutoId ;
      private short wcpOAV6PaisProdutoId ;
      ...
      private int edtPaisProdutoId_Visible ;
      ...
      private string sCtrlAV6PaisProdutoId ;
      ...
      private short[] H001M2_A26PaisProdutoId ;
      private string[] H001M2_A31CategoriaProdutoNome ;
      private short[] H001M2_A30CategoriaProdutoId ;
      private string[] H001M2_A29FornecedorProdutoNome ;
      private short[] H001M2_A28FornecedorProdutoId ;
      private string[] H001M2_A40001VendedorProdutoImagem_GXI ;
      private bool[] H001M2_n40001VendedorProdutoImagem_GXI ;
      private string[] H001M2_A25VendedorProdutoNome ;
      private short[] H001M2_A24VendedorProdutoId ;
      private string[] H001M2_A40000ProdutoImagem_GXI ;
      private decimal[] H001M2_A22ProdutoPreco ;
      private string[] H001M2_A21ProdutoDescricao ;
      private string[] H001M2_A20ProdutoNome ;
      private short[] H001M2_A19ProdutoId ;
      private string[] H001M2_A68VendedorProdutoImagem ;
      private string[] H001M2_A23ProdutoImagem ;
   ...
   public class paisprodutowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6PaisProdutoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001M2", "SELECT T1.[PaisProdutoId], T2.[CategoriaNome] AS CategoriaProdutoNome, T1.[CategoriaProdutoId] AS CategoriaProdutoId, T3.[FornecedorNome] AS FornecedorProdutoNome, T1.[FornecedorProdutoId] AS FornecedorProdutoId, T4.[VendedorFoto_GXI] AS VendedorProdutoImagem_GXI, T4.[VendedorNome] AS VendedorProdutoNome, T1.[VendedorProdutoId] AS VendedorProdutoId, T1.[ProdutoImagem_GXI], T1.[ProdutoPreco], T1.[ProdutoDescricao], T1.[ProdutoNome], T1.[ProdutoId], T4.[VendedorFoto] AS VendedorProdutoImagem, T1.[ProdutoImagem] FROM ((([Produto] T1 INNER JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Fornecedor] T3 ON T3.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Vendedor] T4 ON T4.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[PaisProdutoId] = @AV6PaisProdutoId ORDER BY T1.[PaisProdutoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001M2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001M3", "SELECT COUNT(*) FROM ((([Produto] T1 INNER JOIN [Categoria] T4 ON T4.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Fornecedor] T3 ON T3.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Vendedor] T2 ON T2.[VendedorId] = T1.[VendedorProdutoId]) WHERE T1.[PaisProdutoId] = @AV6PaisProdutoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001M3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
