...
namespace GeneXus.Programs {
   public class vendedorprodutowc : GXWebComponent
   {
      public vendedorprodutowc( )
      {
      ...
      public vendedorprodutowc( IGxContext context )
      {
      ...
      public void execute( short aP0_VendedorProdutoId )
      {
         this.AV6VendedorProdutoId = aP0_VendedorProdutoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "VendedorProdutoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6VendedorProdutoId = (short)(NumberUtil.Val( GetPar( "VendedorProdutoId"), "."));
                  AssignAttri(sPrefix, false, "AV6VendedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6VendedorProdutoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6VendedorProdutoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6VendedorProdutoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Vendedor Produto WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("vendedorprodutowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6VendedorProdutoId,4,0))}, new string[] {"VendedorProdutoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6VendedorProdutoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6VendedorProdutoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vVENDEDORPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6VendedorProdutoId), 4, 0, ".", "")));
      ...
      {
         return "VendedorProdutoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Vendedor Produto WC" ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "vendedorprodutowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_VendedorProdutoWC.htm");
      ...
      protected void START0S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Vendedor Produto WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {AV6VendedorProdutoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A24VendedorProdutoId = H000S2_A24VendedorProdutoId[0];
               AssignAttri(sPrefix, false, "A24VendedorProdutoId", StringUtil.LTrimStr( (decimal)(A24VendedorProdutoId), 4, 0));
               A31CategoriaProdutoNome = H000S2_A31CategoriaProdutoNome[0];
               A30CategoriaProdutoId = H000S2_A30CategoriaProdutoId[0];
               A29FornecedorProdutoNome = H000S2_A29FornecedorProdutoNome[0];
               A28FornecedorProdutoId = H000S2_A28FornecedorProdutoId[0];
               A27PaisProdutoNome = H000S2_A27PaisProdutoNome[0];
               A26PaisProdutoId = H000S2_A26PaisProdutoId[0];
               A40000ProdutoImagem_GXI = H000S2_A40000ProdutoImagem_GXI[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A22ProdutoPreco = H000S2_A22ProdutoPreco[0];
               A21ProdutoDescricao = H000S2_A21ProdutoDescricao[0];
               A20ProdutoNome = H000S2_A20ProdutoNome[0];
               A19ProdutoId = H000S2_A19ProdutoId[0];
               A23ProdutoImagem = H000S2_A23ProdutoImagem[0];
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProdutoImagem)) ? A40000ProdutoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A23ProdutoImagem))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProdutoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A23ProdutoImagem), true);
               A31CategoriaProdutoNome = H000S2_A31CategoriaProdutoNome[0];
               A29FornecedorProdutoNome = H000S2_A29FornecedorProdutoNome[0];
      ...
      {
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {AV6VendedorProdutoId});
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6VendedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6VendedorProdutoId"), ".", ","));
      ...
      protected void E120S2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtVendedorProdutoId_Visible = 0;
         AssignProp(sPrefix, false, edtVendedorProdutoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtVendedorProdutoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "VendedorProdutoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6VendedorProdutoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6VendedorProdutoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6VendedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6VendedorProdutoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6VendedorProdutoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "vendedorprodutowc", GetJustCreated( ));
         ...
         {
            AV6VendedorProdutoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6VendedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6VendedorProdutoId), 4, 0));
         }
         wcpOAV6VendedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6VendedorProdutoId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6VendedorProdutoId != wcpOAV6VendedorProdutoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6VendedorProdutoId = AV6VendedorProdutoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6VendedorProdutoId = cgiGet( sPrefix+"AV6VendedorProdutoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6VendedorProdutoId) > 0 )
         {
            AV6VendedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6VendedorProdutoId), ".", ","));
            AssignAttri(sPrefix, false, "AV6VendedorProdutoId", StringUtil.LTrimStr( (decimal)(AV6VendedorProdutoId), 4, 0));
         }
         else
         {
            AV6VendedorProdutoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6VendedorProdutoId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6VendedorProdutoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6VendedorProdutoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6VendedorProdutoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6VendedorProdutoId_CTRL", StringUtil.RTrim( sCtrlAV6VendedorProdutoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513730", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("vendedorprodutowc.js", "?202582916513730", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         edtVendedorProdutoId_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6VendedorProdutoId',fld:'vVENDEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130S2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110S2',iparms:[{av:'A19ProdutoId',fld:'PRODUTOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6VendedorProdutoId',fld:'vVENDEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6VendedorProdutoId',fld:'vVENDEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6VendedorProdutoId',fld:'vVENDEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6VendedorProdutoId',fld:'vVENDEDORPRODUTOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000S2_A24VendedorProdutoId = new short[1] ;
         H000S2_A31CategoriaProdutoNome = new string[] {""} ;
         H000S2_A30CategoriaProdutoId = new short[1] ;
         H000S2_A29FornecedorProdutoNome = new string[] {""} ;
         H000S2_A28FornecedorProdutoId = new short[1] ;
         H000S2_A27PaisProdutoNome = new string[] {""} ;
         H000S2_A26PaisProdutoId = new short[1] ;
         H000S2_A40000ProdutoImagem_GXI = new string[] {""} ;
         H000S2_A22ProdutoPreco = new decimal[1] ;
         H000S2_A21ProdutoDescricao = new string[] {""} ;
         H000S2_A20ProdutoNome = new string[] {""} ;
         H000S2_A19ProdutoId = new short[1] ;
         H000S2_A23ProdutoImagem = new string[] {""} ;
         ...
         sCtrlAV6VendedorProdutoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.vendedorprodutowc__default(),
            new Object[][] {
                new Object[] {
               H000S2_A24VendedorProdutoId, H000S2_A31CategoriaProdutoNome, H000S2_A30CategoriaProdutoId, H000S2_A29FornecedorProdutoNome, H000S2_A28FornecedorProdutoId, H000S2_A27PaisProdutoNome, H000S2_A26PaisProdutoId, H000S2_A40000ProdutoImagem_GXI, H000S2_A22ProdutoPreco, H000S2_A21ProdutoDescricao,
               H000S2_A20ProdutoNome, H000S2_A19ProdutoId, H000S2_A23ProdutoImagem
               }
               , new Object[] {
      ...
      private short AV6VendedorProdutoId ;
      private short wcpOAV6VendedorProdutoId ;
      ...
      private int edtVendedorProdutoId_Visible ;
      ...
      private string sCtrlAV6VendedorProdutoId ;
      ...
      private short[] H000S2_A24VendedorProdutoId ;
      private string[] H000S2_A31CategoriaProdutoNome ;
      private short[] H000S2_A30CategoriaProdutoId ;
      private string[] H000S2_A29FornecedorProdutoNome ;
      private short[] H000S2_A28FornecedorProdutoId ;
      private string[] H000S2_A27PaisProdutoNome ;
      private short[] H000S2_A26PaisProdutoId ;
      private string[] H000S2_A40000ProdutoImagem_GXI ;
      private decimal[] H000S2_A22ProdutoPreco ;
      private string[] H000S2_A21ProdutoDescricao ;
      private string[] H000S2_A20ProdutoNome ;
      private short[] H000S2_A19ProdutoId ;
      private string[] H000S2_A23ProdutoImagem ;
   ...
   public class vendedorprodutowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6VendedorProdutoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT T1.[VendedorProdutoId], T2.[CategoriaNome] AS CategoriaProdutoNome, T1.[CategoriaProdutoId] AS CategoriaProdutoId, T3.[FornecedorNome] AS FornecedorProdutoNome, T1.[FornecedorProdutoId] AS FornecedorProdutoId, T4.[PaisNome] AS PaisProdutoNome, T1.[PaisProdutoId] AS PaisProdutoId, T1.[ProdutoImagem_GXI], T1.[ProdutoPreco], T1.[ProdutoDescricao], T1.[ProdutoNome], T1.[ProdutoId], T1.[ProdutoImagem] FROM ((([Produto] T1 INNER JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Fornecedor] T3 ON T3.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Pais] T4 ON T4.[PaisId] = T1.[PaisProdutoId]) WHERE T1.[VendedorProdutoId] = @AV6VendedorProdutoId ORDER BY T1.[VendedorProdutoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000S3", "SELECT COUNT(*) FROM ((([Produto] T1 INNER JOIN [Categoria] T4 ON T4.[CategoriaId] = T1.[CategoriaProdutoId]) INNER JOIN [Fornecedor] T3 ON T3.[FornecedorId] = T1.[FornecedorProdutoId]) INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisProdutoId]) WHERE T1.[VendedorProdutoId] = @AV6VendedorProdutoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
