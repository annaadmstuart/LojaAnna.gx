...
namespace GeneXus.Programs {
   public class viewcartaopontos : GXDataArea
   {
      public viewcartaopontos( )
      {
      ...
      public viewcartaopontos( IGxContext context )
      {
      ...
      public void execute( short aP0_CartaoPontosId ,
                           string aP1_TabCode )
      {
         this.AV12CartaoPontosId = aP0_CartaoPontosId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CartaoPontosId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12CartaoPontosId", StringUtil.LTrimStr( (decimal)(AV12CartaoPontosId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCARTAOPONTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CartaoPontosId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcartaopontos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CartaoPontosId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CartaoPontosId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewCartaoPontos");
         forbiddenHiddens.Add("CartaoPontosDescricao", StringUtil.RTrim( context.localUtil.Format( A42CartaoPontosDescricao, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewcartaopontos:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCARTAOPONTOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CartaoPontosId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCARTAOPONTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CartaoPontosId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewcartaopontos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CartaoPontosId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CartaoPontosId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewCartaoPontos" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Cartao Pontos" ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Cartão de pontoss", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCartaoPontos.htm");
            ...
            GxWebStd.gx_label_element( context, edtCartaoPontosDescricao_Internalname, "Descrição", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCartaoPontosDescricao_Internalname, A42CartaoPontosDescricao, StringUtil.RTrim( context.localUtil.Format( A42CartaoPontosDescricao, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCartaoPontosDescricao_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtCartaoPontosDescricao_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_ViewCartaoPontos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCartaoPontos.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCliente_title_Internalname, "Cartão", "", "", lblCliente_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCartaoPontos.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablecliente_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0034"+"", StringUtil.RTrim( WebComp_Clientewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START1B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Cartao Pontos", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 34 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Clientewc_Component) != 0 )
                           {
                              WebComp_Clientewc.componentprocess("W0034", "", sEvt);
                           }
                           WebComp_Clientewc_Component = OldClientewc;
                        }
                     }
      ...
      protected void RF1B2( )
      {
         ...
         {
            /* Using cursor H001B2 */
            pr_default.execute(0, new Object[] {AV12CartaoPontosId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A41CartaoPontosId = H001B2_A41CartaoPontosId[0];
               A42CartaoPontosDescricao = H001B2_A42CartaoPontosDescricao[0];
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12CartaoPontosId = (short)(context.localUtil.CToN( cgiGet( "vCARTAOPONTOSID"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewcartaopontos:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111B2( )
      {
         ...
         AV16GXLvl7 = 0;
         /* Using cursor H001B3 */
         pr_default.execute(1, new Object[] {AV12CartaoPontosId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A41CartaoPontosId = H001B3_A41CartaoPontosId[0];
            A42CartaoPontosDescricao = H001B3_A42CartaoPontosDescricao[0];
            AssignAttri("", false, "A42CartaoPontosDescricao", A42CartaoPontosDescricao);
            AV16GXLvl7 = 1;
            Form.Caption = A42CartaoPontosDescricao;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcartaopontos.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CartaoPontosGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "cartaopontosgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CartaoPontosGeneral";
               WebComp_Generalwc_Component = "CartaoPontosGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12CartaoPontosId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Cliente") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Clientewc_Component), StringUtil.Lower( "CartaoPontosClienteWC")) != 0 )
            {
               WebComp_Clientewc = getWebComponent(GetType(), "GeneXus.Programs", "cartaopontosclientewc", new Object[] {context} );
               WebComp_Clientewc.ComponentInit();
               WebComp_Clientewc.Name = "CartaoPontosClienteWC";
               WebComp_Clientewc_Component = "CartaoPontosClienteWC";
            }
            if ( StringUtil.Len( WebComp_Clientewc_Component) != 0 )
            {
               WebComp_Clientewc.setjustcreated();
               WebComp_Clientewc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12CartaoPontosId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12CartaoPontosId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12CartaoPontosId", StringUtil.LTrimStr( (decimal)(AV12CartaoPontosId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCARTAOPONTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CartaoPontosId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916514074", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcartaopontos.js", "?202582916514074", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Cartao Pontos";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CartaoPontosId',fld:'vCARTAOPONTOSID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A42CartaoPontosDescricao',fld:'CARTAOPONTOSDESCRICAO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001B2_A41CartaoPontosId = new short[1] ;
         H001B2_A42CartaoPontosDescricao = new string[] {""} ;
         hsh = "";
         H001B3_A41CartaoPontosId = new short[1] ;
         H001B3_A42CartaoPontosDescricao = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcartaopontos__default(),
            new Object[][] {
                new Object[] {
               H001B2_A41CartaoPontosId, H001B2_A42CartaoPontosDescricao
               }
               , new Object[] {
               H001B3_A41CartaoPontosId, H001B3_A42CartaoPontosDescricao
               }
            }
         );
      ...
      private short AV12CartaoPontosId ;
      private short wcpOAV12CartaoPontosId ;
      ...
      private short[] H001B2_A41CartaoPontosId ;
      private string[] H001B2_A42CartaoPontosDescricao ;
      private short[] H001B3_A41CartaoPontosId ;
      private string[] H001B3_A42CartaoPontosDescricao ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewcartaopontos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12CartaoPontosId",GXType.Int16,4,0)
          };
          Object[] prmH001B3;
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT [CartaoPontosId], [CartaoPontosDescricao] FROM [CartaoPontos] WHERE [CartaoPontosId] = @AV12CartaoPontosId ORDER BY [CartaoPontosId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001B3", "SELECT [CartaoPontosId], [CartaoPontosDescricao] FROM [CartaoPontos] WHERE [CartaoPontosId] = @AV12CartaoPontosId ORDER BY [CartaoPontosId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
