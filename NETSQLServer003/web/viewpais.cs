...
namespace GeneXus.Programs {
   public class viewpais : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("PaisNome", StringUtil.RTrim( context.localUtil.Format( A2PaisNome, "")));
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtPaisNome_Internalname, "País", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisNome_Internalname, A2PaisNome, StringUtil.RTrim( context.localUtil.Format( A2PaisNome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNome_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPaisNome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Nome", "left", true, "", "HLP_ViewPais.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVendedor_title_Internalname, "País", "", "", lblVendedor_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablevendedor_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCliente_title_Internalname, "País", "", "", lblCliente_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduto_title_Internalname, "País", "", "", lblProduto_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0050"+"", StringUtil.RTrim( WebComp_Produtowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 50 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
                           {
                              WebComp_Produtowc.componentprocess("W0050", "", sEvt);
                           }
                           WebComp_Produtowc_Component = OldProdutowc;
                        }
                     }
      ...
      protected void RF102( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A2PaisNome = H00102_A2PaisNome[0];
               AssignAttri("", false, "A2PaisNome", A2PaisNome);
               /* Execute user event: Load */
               E12102 ();
      ...
      protected void E11102( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A2PaisNome = H00103_A2PaisNome[0];
            AssignAttri("", false, "A2PaisNome", A2PaisNome);
            AV16GXLvl7 = 1;
            Form.Caption = A2PaisNome;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Vendedor") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Vendedorwc_Component) != 0 )
            {
               ...
               WebComp_Vendedorwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12PaisId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Cliente") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Clientewc_Component) != 0 )
            {
               ...
               WebComp_Clientewc.componentprepare(new Object[] {(string)"W0042",(string)"",(short)AV12PaisId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Produto") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Produtowc_Component), StringUtil.Lower( "PaisProdutoWC")) != 0 )
            {
               WebComp_Produtowc = getWebComponent(GetType(), "GeneXus.Programs", "paisprodutowc", new Object[] {context} );
               WebComp_Produtowc.ComponentInit();
               WebComp_Produtowc.Name = "PaisProdutoWC";
               WebComp_Produtowc_Component = "PaisProdutoWC";
            }
            if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
            {
               WebComp_Produtowc.setjustcreated();
               WebComp_Produtowc.componentprepare(new Object[] {(string)"W0050",(string)"",(short)AV12PaisId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513975", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpais.js", "?202582916513975", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12PaisId',fld:'vPAISID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2PaisNome',fld:'PAISNOME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H00102_A2PaisNome = new string[] {""} ;
         hsh = "";
         H00103_A1PaisId = new short[1] ;
         H00103_A2PaisNome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpais__default(),
            new Object[][] {
                new Object[] {
               H00102_A1PaisId, H00102_A2PaisNome
               }
               , new Object[] {
               H00103_A1PaisId, H00103_A2PaisNome
               }
            }
         );
      ...
      private string[] H00102_A2PaisNome ;
      private short[] H00103_A1PaisId ;
      private string[] H00103_A2PaisNome ;
   ...
   public class viewpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT [PaisId], [PaisNome] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00103", "SELECT [PaisId], [PaisNome] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
