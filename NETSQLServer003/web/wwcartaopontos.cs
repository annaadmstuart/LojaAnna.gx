...
namespace GeneXus.Programs {
   public class wwcartaopontos : GXDataArea
   {
      public wwcartaopontos( )
      {
      ...
      public wwcartaopontos( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11CartaoPontosDescricao = GetPar( "CartaoPontosDescricao");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11CartaoPontosDescricao, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwcartaopontos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCARTAOPONTOSDESCRICAO", AV11CartaoPontosDescricao);
         /* Send saved values. */
      ...
      {
         return formatLink("wwcartaopontos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWCartaoPontos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cartão de pontoss" ;
      }
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Cartão de pontoss", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWCartaoPontos.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCartaoPontos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavCartaopontosdescricao_Internalname, "Cartao Pontos Descricao", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCartaopontosdescricao_Internalname, AV11CartaoPontosDescricao, StringUtil.RTrim( context.localUtil.Format( AV11CartaoPontosDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descrição", edtavCartaopontosdescricao_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCartaopontosdescricao_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWCartaoPontos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START162( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Cartão de pontoss", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Cartaopontosdescricao Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCARTAOPONTOSDESCRICAO"), AV11CartaoPontosDescricao) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA162( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavCartaopontosdescricao_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11CartaoPontosDescricao ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      protected void RF162( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11CartaoPontosDescricao = StringUtil.Concat( StringUtil.RTrim( AV11CartaoPontosDescricao), "%", "");
            /* Using cursor H00164 */
            pr_default.execute(0, new Object[] {lV11CartaoPontosDescricao, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A51ClienteCartaoPontosNome = H00164_A51ClienteCartaoPontosNome[0];
               A50ClienteCartaoPontosId = H00164_A50ClienteCartaoPontosId[0];
               A42CartaoPontosDescricao = H00164_A42CartaoPontosDescricao[0];
               A41CartaoPontosId = H00164_A41CartaoPontosId[0];
               A66CartaoPontosAcumulados = H00164_A66CartaoPontosAcumulados[0];
               n66CartaoPontosAcumulados = H00164_n66CartaoPontosAcumulados[0];
               A51ClienteCartaoPontosNome = H00164_A51ClienteCartaoPontosNome[0];
               A66CartaoPontosAcumulados = H00164_A66CartaoPontosAcumulados[0];
               n66CartaoPontosAcumulados = H00164_n66CartaoPontosAcumulados[0];
               E14162 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CARTAOPONTOSID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A41CartaoPontosId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11CartaoPontosDescricao = StringUtil.Concat( StringUtil.RTrim( AV11CartaoPontosDescricao), "%", "");
         /* Using cursor H00167 */
         pr_default.execute(1, new Object[] {lV11CartaoPontosDescricao});
         GRID_nRecordCount = H00167_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11CartaoPontosDescricao = GridState.FilterValues("Cartaopontosdescricao");
            AssignAttri("", false, "AV11CartaoPontosDescricao", AV11CartaoPontosDescricao);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("CartaoPontosDescricao", AV11CartaoPontosDescricao);
      }
      ...
      protected void STRUP160( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11CartaoPontosDescricao = cgiGet( edtavCartaopontosdescricao_Internalname);
            AssignAttri("", false, "AV11CartaoPontosDescricao", AV11CartaoPontosDescricao);
      ...
      protected void E12162( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri("", false, edtavDelete_Internalname, AV13Delete);
         Form.Caption = "Cartão de pontoss";
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "CartaoPontos";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916514036", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcartaopontos.js", "?202582916514036", false, true);
         }
      ...
      {
         edtCartaoPontosId_Internalname = "CARTAOPONTOSID_"+sGXsfl_27_idx;
         edtCartaoPontosDescricao_Internalname = "CARTAOPONTOSDESCRICAO_"+sGXsfl_27_idx;
         edtClienteCartaoPontosId_Internalname = "CLIENTECARTAOPONTOSID_"+sGXsfl_27_idx;
         edtClienteCartaoPontosNome_Internalname = "CLIENTECARTAOPONTOSNOME_"+sGXsfl_27_idx;
         edtCartaoPontosAcumulados_Internalname = "CARTAOPONTOSACUMULADOS_"+sGXsfl_27_idx;
      ...
      {
         edtCartaoPontosId_Internalname = "CARTAOPONTOSID_"+sGXsfl_27_fel_idx;
         edtCartaoPontosDescricao_Internalname = "CARTAOPONTOSDESCRICAO_"+sGXsfl_27_fel_idx;
         edtClienteCartaoPontosId_Internalname = "CLIENTECARTAOPONTOSID_"+sGXsfl_27_fel_idx;
         edtClienteCartaoPontosNome_Internalname = "CLIENTECARTAOPONTOSNOME_"+sGXsfl_27_fel_idx;
         edtCartaoPontosAcumulados_Internalname = "CARTAOPONTOSACUMULADOS_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCartaoPontosId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A41CartaoPontosId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A41CartaoPontosId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCartaoPontosId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteCartaoPontosId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A50ClienteCartaoPontosId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A50ClienteCartaoPontosId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteCartaoPontosId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteCartaoPontosNome_Internalname,(string)A51ClienteCartaoPontosNome,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteCartaoPontosNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCartaoPontosAcumulados_Internalname,StringUtil.LTrim( StringUtil.NToC( A66CartaoPontosAcumulados, 10, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A66CartaoPontosAcumulados, "ZZZZZZ9.99")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCartaoPontosAcumulados_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A50ClienteCartaoPontosId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A51ClienteCartaoPontosNome);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavCartaopontosdescricao_Internalname = "vCARTAOPONTOSDESCRICAO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCartaopontosdescricao_Jsonclick = "";
         edtavCartaopontosdescricao_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11CartaoPontosDescricao',fld:'vCARTAOPONTOSDESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14162',iparms:[{av:'A41CartaoPontosId',fld:'CARTAOPONTOSID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11162',iparms:[{av:'A41CartaoPontosId',fld:'CARTAOPONTOSID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11CartaoPontosDescricao',fld:'vCARTAOPONTOSDESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11CartaoPontosDescricao',fld:'vCARTAOPONTOSDESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11CartaoPontosDescricao',fld:'vCARTAOPONTOSDESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11CartaoPontosDescricao',fld:'vCARTAOPONTOSDESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11CartaoPontosDescricao = "";
         H00164_A51ClienteCartaoPontosNome = new string[] {""} ;
         H00164_A50ClienteCartaoPontosId = new short[1] ;
         H00164_A42CartaoPontosDescricao = new string[] {""} ;
         H00164_A41CartaoPontosId = new short[1] ;
         H00164_A66CartaoPontosAcumulados = new decimal[1] ;
         H00164_n66CartaoPontosAcumulados = new bool[] {false} ;
         H00167_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcartaopontos__default(),
            new Object[][] {
                new Object[] {
               H00164_A51ClienteCartaoPontosNome, H00164_A50ClienteCartaoPontosId, H00164_A42CartaoPontosDescricao, H00164_A41CartaoPontosId, H00164_A66CartaoPontosAcumulados, H00164_n66CartaoPontosAcumulados
               }
               , new Object[] {
               H00167_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "WWCartaoPontos";
      ...
      private int edtavCartaopontosdescricao_Enabled ;
      ...
      private string edtavCartaopontosdescricao_Internalname ;
      private string edtavCartaopontosdescricao_Jsonclick ;
      ...
      private string AV11CartaoPontosDescricao ;
      private string A42CartaoPontosDescricao ;
      private string A51ClienteCartaoPontosNome ;
      private string lV11CartaoPontosDescricao ;
      ...
      private string[] H00164_A51ClienteCartaoPontosNome ;
      private short[] H00164_A50ClienteCartaoPontosId ;
      private string[] H00164_A42CartaoPontosDescricao ;
      private short[] H00164_A41CartaoPontosId ;
      private decimal[] H00164_A66CartaoPontosAcumulados ;
      private bool[] H00164_n66CartaoPontosAcumulados ;
      private long[] H00167_AGRID_nRecordCount ;
   ...
   public class wwcartaopontos__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00164( IGxContext context ,
                                             string AV11CartaoPontosDescricao ,
                                             string A42CartaoPontosDescricao )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[ClienteNome] AS ClienteCartaoPontosNome, T1.[ClienteCartaoPontosId] AS ClienteCartaoPontosId, T1.[CartaoPontosDescricao], T1.[CartaoPontosId], COALESCE( T3.[CartaoPontosAcumulados], 0) AS CartaoPontosAcumulados";
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11CartaoPontosDescricao)) )
         {
            AddWhere(sWhereString, "(T1.[CartaoPontosDescricao] like @lV11CartaoPontosDescricao)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[CartaoPontosDescricao]";
      ...
      protected Object[] conditional_H00167( IGxContext context ,
                                             string AV11CartaoPontosDescricao ,
                                             string A42CartaoPontosDescricao )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00164(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H00167(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00164;
          prmH00164 = new Object[] {
          new ParDef("@lV11CartaoPontosDescricao",GXType.NVarChar,20,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH00167;
          prmH00167 = new Object[] {
          new ParDef("@lV11CartaoPontosDescricao",GXType.NVarChar,20,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00164", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00164,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00167", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00167,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
