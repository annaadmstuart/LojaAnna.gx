   ...
   public class wwcategoria : GXDataArea
   {
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavCategorianome_Internalname, "Categoria Nome", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCategorianome_Internalname, AV11CategoriaNome, StringUtil.RTrim( context.localUtil.Format( AV11CategoriaNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nome", edtavCategorianome_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCategorianome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWCategoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF132( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5CategoriaNome = H00132_A5CategoriaNome[0];
               A4CategoriaId = H00132_A4CategoriaId[0];
               E14132 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIAID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A4CategoriaId), "ZZZ9"), context));
      }
      ...
      private void E14132( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A4CategoriaId,4,0))}, new string[] {"Mode","CategoriaId"}) ;
         edtavDelete_Link = formatLink("categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A4CategoriaId,4,0))}, new string[] {"Mode","CategoriaId"}) ;
         edtCategoriaNome_Link = formatLink("viewcategoria.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A4CategoriaId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"CategoriaId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513995", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcategoria.js", "?202582916513995", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_27_fel_idx;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CategoriaId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A5CategoriaNome);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E14132',iparms:[{av:'A4CategoriaId',fld:'CATEGORIAID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11132',iparms:[{av:'A4CategoriaId',fld:'CATEGORIAID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11CategoriaNome = "";
         H00132_A5CategoriaNome = new string[] {""} ;
         H00132_A4CategoriaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcategoria__default(),
            new Object[][] {
                new Object[] {
               H00132_A5CategoriaNome, H00132_A4CategoriaId
               }
               , new Object[] {
      ...
      private string[] H00132_A5CategoriaNome ;
      private short[] H00132_A4CategoriaId ;
