...
namespace GeneXus.Programs {
   public class wwcliente : GXDataArea
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtPaisClienteBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A69PaisClienteBandeira)) ? A40000PaisClienteBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A69PaisClienteBandeira))), !bGXsfl_27_Refreshing);
      ...
      protected void RF0L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000PaisClienteBandeira_GXI = H000L2_A40000PaisClienteBandeira_GXI[0];
               n40000PaisClienteBandeira_GXI = H000L2_n40000PaisClienteBandeira_GXI[0];
               AssignProp("", false, edtPaisClienteBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A69PaisClienteBandeira)) ? A40000PaisClienteBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A69PaisClienteBandeira))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPaisClienteBandeira_Internalname, "SrcSet", context.GetImageSrcSet( A69PaisClienteBandeira), true);
               A49CartaoPontosClienteDescricao = H000L2_A49CartaoPontosClienteDescricao[0];
               A48CartaoPontosClienteId = H000L2_A48CartaoPontosClienteId[0];
               n48CartaoPontosClienteId = H000L2_n48CartaoPontosClienteId[0];
               A12PaisClienteNome = H000L2_A12PaisClienteNome[0];
               A11PaisClienteId = H000L2_A11PaisClienteId[0];
               A47ClienteEmail = H000L2_A47ClienteEmail[0];
               A46ClienteTelefone = H000L2_A46ClienteTelefone[0];
               A45ClienteEndereco = H000L2_A45ClienteEndereco[0];
               A44ClienteNome = H000L2_A44ClienteNome[0];
               A43ClienteId = H000L2_A43ClienteId[0];
               A69PaisClienteBandeira = H000L2_A69PaisClienteBandeira[0];
               AssignProp("", false, edtPaisClienteBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A69PaisClienteBandeira)) ? A40000PaisClienteBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A69PaisClienteBandeira))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPaisClienteBandeira_Internalname, "SrcSet", context.GetImageSrcSet( A69PaisClienteBandeira), true);
               A49CartaoPontosClienteDescricao = H000L2_A49CartaoPontosClienteDescricao[0];
               A40000PaisClienteBandeira_GXI = H000L2_A40000PaisClienteBandeira_GXI[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A43ClienteId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513940", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcliente.js", "?202582916513940", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtClienteEndereco_Internalname = "CLIENTEENDERECO_"+sGXsfl_27_idx;
         edtClienteTelefone_Internalname = "CLIENTETELEFONE_"+sGXsfl_27_idx;
         edtClienteEmail_Internalname = "CLIENTEEMAIL_"+sGXsfl_27_idx;
         edtPaisClienteId_Internalname = "PAISCLIENTEID_"+sGXsfl_27_idx;
         edtPaisClienteNome_Internalname = "PAISCLIENTENOME_"+sGXsfl_27_idx;
         edtCartaoPontosClienteId_Internalname = "CARTAOPONTOSCLIENTEID_"+sGXsfl_27_idx;
         edtCartaoPontosClienteDescricao_Internalname = "CARTAOPONTOSCLIENTEDESCRICAO_"+sGXsfl_27_idx;
         chkClienteVIP_Internalname = "CLIENTEVIP_"+sGXsfl_27_idx;
         edtPaisClienteBandeira_Internalname = "PAISCLIENTEBANDEIRA_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtClienteEndereco_Internalname = "CLIENTEENDERECO_"+sGXsfl_27_fel_idx;
         ...
         edtPaisClienteId_Internalname = "PAISCLIENTEID_"+sGXsfl_27_fel_idx;
         edtPaisClienteNome_Internalname = "PAISCLIENTENOME_"+sGXsfl_27_fel_idx;
         edtCartaoPontosClienteId_Internalname = "CARTAOPONTOSCLIENTEID_"+sGXsfl_27_fel_idx;
         edtCartaoPontosClienteDescricao_Internalname = "CARTAOPONTOSCLIENTEDESCRICAO_"+sGXsfl_27_fel_idx;
         chkClienteVIP_Internalname = "CLIENTEVIP_"+sGXsfl_27_fel_idx;
         edtPaisClienteBandeira_Internalname = "PAISCLIENTEBANDEIRA_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A43ClienteId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A43ClienteId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisClienteNome_Internalname,(string)A12PaisClienteNome,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisClienteNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "CLIENTEVIP_" + sGXsfl_27_idx;
            chkClienteVIP.Name = GXCCtl;
            chkClienteVIP.WebTags = "";
            chkClienteVIP.Caption = "";
            AssignProp("", false, chkClienteVIP_Internalname, "TitleCaption", chkClienteVIP.Caption, !bGXsfl_27_Refreshing);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140L2',iparms:[{av:'A43ClienteId',fld:'CLIENTEID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110L2',iparms:[{av:'A43ClienteId',fld:'CLIENTEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11ClienteNome = "";
         H000L2_A40000PaisClienteBandeira_GXI = new string[] {""} ;
         H000L2_n40000PaisClienteBandeira_GXI = new bool[] {false} ;
         H000L2_A49CartaoPontosClienteDescricao = new string[] {""} ;
         H000L2_A48CartaoPontosClienteId = new short[1] ;
         H000L2_n48CartaoPontosClienteId = new bool[] {false} ;
         H000L2_A12PaisClienteNome = new string[] {""} ;
         H000L2_A11PaisClienteId = new short[1] ;
         H000L2_A47ClienteEmail = new string[] {""} ;
         H000L2_A46ClienteTelefone = new string[] {""} ;
         H000L2_A45ClienteEndereco = new string[] {""} ;
         H000L2_A44ClienteNome = new string[] {""} ;
         H000L2_A43ClienteId = new short[1] ;
         H000L2_A69PaisClienteBandeira = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcliente__default(),
            new Object[][] {
                new Object[] {
               H000L2_A40000PaisClienteBandeira_GXI, H000L2_n40000PaisClienteBandeira_GXI, H000L2_A49CartaoPontosClienteDescricao, H000L2_A48CartaoPontosClienteId, H000L2_n48CartaoPontosClienteId, H000L2_A12PaisClienteNome, H000L2_A11PaisClienteId, H000L2_A47ClienteEmail, H000L2_A46ClienteTelefone, H000L2_A45ClienteEndereco,
               H000L2_A44ClienteNome, H000L2_A43ClienteId, H000L2_A69PaisClienteBandeira
               }
               , new Object[] {
      ...
      private string[] H000L2_A40000PaisClienteBandeira_GXI ;
      private bool[] H000L2_n40000PaisClienteBandeira_GXI ;
      private string[] H000L2_A49CartaoPontosClienteDescricao ;
      private short[] H000L2_A48CartaoPontosClienteId ;
      private bool[] H000L2_n48CartaoPontosClienteId ;
      private string[] H000L2_A12PaisClienteNome ;
      private short[] H000L2_A11PaisClienteId ;
      private string[] H000L2_A47ClienteEmail ;
      private string[] H000L2_A46ClienteTelefone ;
      private string[] H000L2_A45ClienteEndereco ;
      private string[] H000L2_A44ClienteNome ;
      private short[] H000L2_A43ClienteId ;
      private string[] H000L2_A69PaisClienteBandeira ;
   ...
   public class wwcliente__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A44ClienteNome )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[PaisBandeira_GXI] AS PaisClienteBandeira_GXI, T2.[CartaoPontosDescricao] AS CartaoPontosClienteDescricao, T1.[CartaoPontosClienteId] AS CartaoPontosClienteId, T3.[PaisNome] AS PaisClienteNome, T1.[PaisClienteId] AS PaisClienteId, T1.[ClienteEmail], T1.[ClienteTelefone], T1.[ClienteEndereco], T1.[ClienteNome], T1.[ClienteId], T3.[PaisBandeira] AS PaisClienteBandeira";
         sFromString = " FROM (([Cliente] T1 LEFT JOIN [CartaoPontos] T2 ON T2.[CartaoPontosId] = T1.[CartaoPontosClienteId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisClienteId])";
         sOrderString = "";
                                             ...
                                             string A44ClienteNome )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Cliente] T1 LEFT JOIN [CartaoPontos] T3 ON T3.[CartaoPontosId] = T1.[CartaoPontosClienteId]) INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisClienteId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ClienteNome)) )
         {
            AddWhere(sWhereString, "(T1.[ClienteNome] like @lV11ClienteNome)");
         }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[12])[0] = rslt.getMultimediaFile(11, rslt.getVarchar(1));
                return;
             case 1 :
