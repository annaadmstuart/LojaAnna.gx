...
namespace GeneXus.Programs {
   public class wwfornecedor : GXDataArea
   {
      public wwfornecedor( )
      {
      ...
      public wwfornecedor( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11FornecedorNome = GetPar( "FornecedorNome");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11FornecedorNome, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwfornecedor.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFORNECEDORNOME", AV11FornecedorNome);
         /* Send saved values. */
      ...
      {
         return formatLink("wwfornecedor.aspx")  ;
      }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Fornecedors", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWFornecedor.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWFornecedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavFornecedornome_Internalname, "Fornecedor Nome", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFornecedornome_Internalname, AV11FornecedorNome, StringUtil.RTrim( context.localUtil.Format( AV11FornecedorNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nome", edtavFornecedornome_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavFornecedornome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWFornecedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START142( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Fornecedors", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Fornecedornome Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFORNECEDORNOME"), AV11FornecedorNome) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA142( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavFornecedornome_Internalname;
      ...
      protected void RF142( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11FornecedorNome = StringUtil.Concat( StringUtil.RTrim( AV11FornecedorNome), "%", "");
            /* Using cursor H00142 */
            pr_default.execute(0, new Object[] {lV11FornecedorNome, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A18FornecedorNome = H00142_A18FornecedorNome[0];
               A17FornecedorId = H00142_A17FornecedorId[0];
               E14142 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_FORNECEDORID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A17FornecedorId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11FornecedorNome = StringUtil.Concat( StringUtil.RTrim( AV11FornecedorNome), "%", "");
         /* Using cursor H00143 */
         pr_default.execute(1, new Object[] {lV11FornecedorNome});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11FornecedorNome = GridState.FilterValues("Fornecedornome");
            AssignAttri("", false, "AV11FornecedorNome", AV11FornecedorNome);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("FornecedorNome", AV11FornecedorNome);
      }
      ...
      protected void STRUP140( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11FornecedorNome = cgiGet( edtavFornecedornome_Internalname);
            AssignAttri("", false, "AV11FornecedorNome", AV11FornecedorNome);
      ...
      private void E14142( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("fornecedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A17FornecedorId,4,0))}, new string[] {"Mode","FornecedorId"}) ;
         edtavDelete_Link = formatLink("fornecedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A17FornecedorId,4,0))}, new string[] {"Mode","FornecedorId"}) ;
         edtFornecedorNome_Link = formatLink("viewfornecedor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A17FornecedorId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"FornecedorId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void E11142( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("fornecedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","FornecedorId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Fornecedor";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20258291651401", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwfornecedor.js", "?20258291651402", false, true);
         }
      ...
      {
         edtFornecedorId_Internalname = "FORNECEDORID_"+sGXsfl_27_idx;
         edtFornecedorNome_Internalname = "FORNECEDORNOME_"+sGXsfl_27_idx;
      ...
      {
         edtFornecedorId_Internalname = "FORNECEDORID_"+sGXsfl_27_fel_idx;
         edtFornecedorNome_Internalname = "FORNECEDORNOME_"+sGXsfl_27_fel_idx;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A17FornecedorId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A18FornecedorNome);
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtFornecedorNome_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavFornecedornome_Internalname = "vFORNECEDORNOME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavFornecedornome_Jsonclick = "";
         edtavFornecedornome_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FornecedorNome',fld:'vFORNECEDORNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14142',iparms:[{av:'A17FornecedorId',fld:'FORNECEDORID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFornecedorNome_Link',ctrl:'FORNECEDORNOME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11142',iparms:[{av:'A17FornecedorId',fld:'FORNECEDORID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FornecedorNome',fld:'vFORNECEDORNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FornecedorNome',fld:'vFORNECEDORNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FornecedorNome',fld:'vFORNECEDORNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FornecedorNome',fld:'vFORNECEDORNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11FornecedorNome = "";
         H00142_A18FornecedorNome = new string[] {""} ;
         H00142_A17FornecedorId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwfornecedor__default(),
            new Object[][] {
                new Object[] {
               H00142_A18FornecedorNome, H00142_A17FornecedorId
               }
               , new Object[] {
      ...
      private int edtavFornecedornome_Enabled ;
      ...
      private string edtavFornecedornome_Internalname ;
      private string edtavFornecedornome_Jsonclick ;
      ...
      private string AV11FornecedorNome ;
      private string A18FornecedorNome ;
      private string lV11FornecedorNome ;
      ...
      private string[] H00142_A18FornecedorNome ;
      private short[] H00142_A17FornecedorId ;
   ...
   public class wwfornecedor__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A18FornecedorNome )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11FornecedorNome)) )
         {
            AddWhere(sWhereString, "([FornecedorNome] like @lV11FornecedorNome)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [FornecedorNome]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11FornecedorNome",GXType.NVarChar,40,0) ,
