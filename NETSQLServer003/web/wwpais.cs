   ...
   public class wwpais : GXDataArea
   {
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavPaisnome_Internalname, "Pais Nome", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPaisnome_Internalname, AV11PaisNome, StringUtil.RTrim( context.localUtil.Format( AV11PaisNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "País", edtavPaisnome_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPaisnome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START112( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "País", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtPaisBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandeira)) ? A40000PaisBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandeira))), !bGXsfl_27_Refreshing);
      ...
      protected void RF112( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000PaisBandeira_GXI = H00112_A40000PaisBandeira_GXI[0];
               AssignProp("", false, edtPaisBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandeira)) ? A40000PaisBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandeira))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPaisBandeira_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandeira), true);
               A2PaisNome = H00112_A2PaisNome[0];
               A1PaisId = H00112_A1PaisId[0];
               A3PaisBandeira = H00112_A3PaisBandeira[0];
               AssignProp("", false, edtPaisBandeira_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandeira)) ? A40000PaisBandeira_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandeira))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPaisBandeira_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandeira), true);
               E14112 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9"), context));
      }
      ...
      private void E14112( )
      {
         ...
         edtPaisNome_Link = formatLink("viewpais.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1PaisId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"PaisId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202582916513994", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpais.js", "?202582916513994", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtPaisNome_Internalname = "PAISNOME_"+sGXsfl_27_idx;
         edtPaisBandeira_Internalname = "PAISBANDEIRA_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtPaisNome_Internalname = "PAISNOME_"+sGXsfl_27_fel_idx;
         edtPaisBandeira_Internalname = "PAISBANDEIRA_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisBandeira_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"column WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A3PaisBandeira_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A2PaisNome);
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtPaisNome_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A3PaisBandeira));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11PaisNome = "";
         H00112_A40000PaisBandeira_GXI = new string[] {""} ;
         H00112_A2PaisNome = new string[] {""} ;
         H00112_A1PaisId = new short[1] ;
         H00112_A3PaisBandeira = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpais__default(),
            new Object[][] {
                new Object[] {
               H00112_A40000PaisBandeira_GXI, H00112_A2PaisNome, H00112_A1PaisId, H00112_A3PaisBandeira
               }
               , new Object[] {
      ...
      private string[] H00112_A40000PaisBandeira_GXI ;
      private string[] H00112_A2PaisNome ;
      private short[] H00112_A1PaisId ;
      private string[] H00112_A3PaisBandeira ;
