...
namespace GeneXus.Programs {
   public class wwpromocao : GXDataArea
   {
      public wwpromocao( )
      {
      ...
      public wwpromocao( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11PromocaoDescricao = GetPar( "PromocaoDescricao");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11PromocaoDescricao, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpromocao.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPROMOCAODESCRICAO", AV11PromocaoDescricao);
         /* Send saved values. */
      ...
      {
         return formatLink("wwpromocao.aspx")  ;
      }
      ...
      protected void WB150( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Promoçãoes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPromocao.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPromocao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavPromocaodescricao_Internalname, "Promocao Descricao", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPromocaodescricao_Internalname, AV11PromocaoDescricao, StringUtil.RTrim( context.localUtil.Format( AV11PromocaoDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descrição", edtavPromocaodescricao_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPromocaodescricao_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWPromocao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtPromocaoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A34PromocaoImagem)) ? A40000PromocaoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A34PromocaoImagem))), !bGXsfl_27_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Promocaodescricao Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPROMOCAODESCRICAO"), AV11PromocaoDescricao) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA152( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavPromocaodescricao_Internalname;
      ...
      protected void RF152( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11PromocaoDescricao ,
                                                 A33PromocaoDescricao } ,
                                                 new int[]{
                                                 }
            });
            lV11PromocaoDescricao = StringUtil.Concat( StringUtil.RTrim( AV11PromocaoDescricao), "%", "");
            /* Using cursor H00152 */
            pr_default.execute(0, new Object[] {lV11PromocaoDescricao, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A36PromocaoDataTermino = H00152_A36PromocaoDataTermino[0];
               A35PromocaoDataInicio = H00152_A35PromocaoDataInicio[0];
               A40000PromocaoImagem_GXI = H00152_A40000PromocaoImagem_GXI[0];
               AssignProp("", false, edtPromocaoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A34PromocaoImagem)) ? A40000PromocaoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A34PromocaoImagem))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPromocaoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A34PromocaoImagem), true);
               A33PromocaoDescricao = H00152_A33PromocaoDescricao[0];
               A32PromocaoId = H00152_A32PromocaoId[0];
               A34PromocaoImagem = H00152_A34PromocaoImagem[0];
               AssignProp("", false, edtPromocaoImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A34PromocaoImagem)) ? A40000PromocaoImagem_GXI : context.convertURL( context.PathToRelativeUrl( A34PromocaoImagem))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtPromocaoImagem_Internalname, "SrcSet", context.GetImageSrcSet( A34PromocaoImagem), true);
               E14152 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PROMOCAOID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A32PromocaoId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11PromocaoDescricao = StringUtil.Concat( StringUtil.RTrim( AV11PromocaoDescricao), "%", "");
         /* Using cursor H00153 */
         pr_default.execute(1, new Object[] {lV11PromocaoDescricao});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11PromocaoDescricao = GridState.FilterValues("Promocaodescricao");
            AssignAttri("", false, "AV11PromocaoDescricao", AV11PromocaoDescricao);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PromocaoDescricao", AV11PromocaoDescricao);
      }
      ...
      protected void STRUP150( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11PromocaoDescricao = cgiGet( edtavPromocaodescricao_Internalname);
            AssignAttri("", false, "AV11PromocaoDescricao", AV11PromocaoDescricao);
      ...
      private void E14152( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("promocao.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A32PromocaoId,4,0))}, new string[] {"Mode","PromocaoId"}) ;
         edtavDelete_Link = formatLink("promocao.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A32PromocaoId,4,0))}, new string[] {"Mode","PromocaoId"}) ;
         edtPromocaoDescricao_Link = formatLink("viewpromocao.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A32PromocaoId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"PromocaoId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void E11152( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("promocao.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","PromocaoId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Promocao";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20258291651406", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpromocao.js", "?20258291651406", false, true);
         }
      ...
      {
         edtPromocaoId_Internalname = "PROMOCAOID_"+sGXsfl_27_idx;
         edtPromocaoDescricao_Internalname = "PROMOCAODESCRICAO_"+sGXsfl_27_idx;
         edtPromocaoImagem_Internalname = "PROMOCAOIMAGEM_"+sGXsfl_27_idx;
         edtPromocaoDataInicio_Internalname = "PROMOCAODATAINICIO_"+sGXsfl_27_idx;
         edtPromocaoDataTermino_Internalname = "PROMOCAODATATERMINO_"+sGXsfl_27_idx;
      ...
      {
         edtPromocaoId_Internalname = "PROMOCAOID_"+sGXsfl_27_fel_idx;
         edtPromocaoDescricao_Internalname = "PROMOCAODESCRICAO_"+sGXsfl_27_fel_idx;
         edtPromocaoImagem_Internalname = "PROMOCAOIMAGEM_"+sGXsfl_27_fel_idx;
         edtPromocaoDataInicio_Internalname = "PROMOCAODATAINICIO_"+sGXsfl_27_fel_idx;
         edtPromocaoDataTermino_Internalname = "PROMOCAODATATERMINO_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPromocaoImagem_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"column WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A34PromocaoImagem_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPromocaoDataInicio_Internalname,context.localUtil.Format(A35PromocaoDataInicio, "99/99/99"),context.localUtil.Format( A35PromocaoDataInicio, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPromocaoDataInicio_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPromocaoDataTermino_Internalname,context.localUtil.Format(A36PromocaoDataTermino, "99/99/99"),context.localUtil.Format( A36PromocaoDataTermino, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPromocaoDataTermino_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A32PromocaoId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A33PromocaoDescricao);
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtPromocaoDescricao_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A34PromocaoImagem));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.localUtil.Format(A35PromocaoDataInicio, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.localUtil.Format(A36PromocaoDataTermino, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavPromocaodescricao_Internalname = "vPROMOCAODESCRICAO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavPromocaodescricao_Jsonclick = "";
         edtavPromocaodescricao_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PromocaoDescricao',fld:'vPROMOCAODESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14152',iparms:[{av:'A32PromocaoId',fld:'PROMOCAOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPromocaoDescricao_Link',ctrl:'PROMOCAODESCRICAO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11152',iparms:[{av:'A32PromocaoId',fld:'PROMOCAOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PromocaoDescricao',fld:'vPROMOCAODESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PromocaoDescricao',fld:'vPROMOCAODESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PromocaoDescricao',fld:'vPROMOCAODESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PromocaoDescricao',fld:'vPROMOCAODESCRICAO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11PromocaoDescricao = "";
         H00152_A36PromocaoDataTermino = new DateTime[] {DateTime.MinValue} ;
         H00152_A35PromocaoDataInicio = new DateTime[] {DateTime.MinValue} ;
         H00152_A40000PromocaoImagem_GXI = new string[] {""} ;
         H00152_A33PromocaoDescricao = new string[] {""} ;
         H00152_A32PromocaoId = new short[1] ;
         H00152_A34PromocaoImagem = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpromocao__default(),
            new Object[][] {
                new Object[] {
               H00152_A36PromocaoDataTermino, H00152_A35PromocaoDataInicio, H00152_A40000PromocaoImagem_GXI, H00152_A33PromocaoDescricao, H00152_A32PromocaoId, H00152_A34PromocaoImagem
               }
               , new Object[] {
      ...
      private int edtavPromocaodescricao_Enabled ;
      ...
      private string edtavPromocaodescricao_Internalname ;
      private string edtavPromocaodescricao_Jsonclick ;
      ...
      private DateTime[] H00152_A36PromocaoDataTermino ;
      private DateTime[] H00152_A35PromocaoDataInicio ;
      private string[] H00152_A40000PromocaoImagem_GXI ;
      private string[] H00152_A33PromocaoDescricao ;
      private short[] H00152_A32PromocaoId ;
      private string[] H00152_A34PromocaoImagem ;
   ...
   public class wwpromocao__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A33PromocaoDescricao )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11PromocaoDescricao)) )
         {
            AddWhere(sWhereString, "([PromocaoDescricao] like @lV11PromocaoDescricao)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [PromocaoDescricao]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PromocaoDescricao",GXType.NVarChar,40,0) ,
